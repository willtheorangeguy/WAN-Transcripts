• Intel Arc desktop GPUs may be cancelled
...
• Rumours of cancellation tied to internal discussions due to project issues
• Octane SSDs are being discontinued by Intel
• AMD confirms four Ry zen 7000 CPUs, possibly by accident
...
• Leaked internal documents suggest that data centre ARK cards will continue to be produced, but dedicated gaming ARK cards may be cancelled
...
• Battle mage may be cancelled due to silicon-level issues
• Intel responds to rumours with commitment to roadmap and ramping Alchemist
• AXG on track to launch four new product lines by end of year
• Barrable-like scenario feared, where consumer product cancelled, but data centre product lives on
• Discussion of the potential for Intel to have a broad product line in order to build up its IP
• Mention of NVIDIA and AMD having wide product lines, but also companies focused on data centre compute devices
• Announcement that Octane has been discontinued by Intel
• Explanation that Micron's withdrawal from manufacturing Octane led to Intel's inability to produce the product
• Discussion of benchmarks for next-gen Octane modules being shown just before its cancellation
• Rumours and speculation about an upcoming statement regarding Octane's discontinuation
• Skepticism about reporting on rumours due to potential inaccuracies or changes in plans
...
• Impact on customer sentiment if Alchemist and Battle mage are both delayed or cancelled
...
• Consumer hardware vs data centre products have similar silicon costs, but pricing is significantly higher for consumer products
...
• Discussion of an AMD promotion featuring bundled Ry zen processors and Radeon graphics cards
• Game bundles and sales on computer hardware
• The show is brought to you by Secret Lab and Ubiquity.
• Secret Lab chairs, specifically the Titan Eve 2022, are discussed with features such as four-way lumbar support and magnetic memory foam head pillow.
...
• A personal anecdote about the host's home being survived by Ubiquity cameras, leading to an unexpected moment of embarrassment.
...
• Warranty information for all builds (1 year on parts and labour)
• Confusion over warranty terms resolved after checking the company's website
• Discussion of expensive builds with custom designs and labour-intensive process
...
• Person expresses satisfaction with new Wi-Fi setup
...
• Question about radio signal mapping and testing with software like Idaho
• Mention of spectrum analysis for resolving issues at the speaker's home
• Discussion of Wi-Fi performance and interference from other devices
• The speaker mentions a experience with a product where they covered it editorially and then had to deal with constant requests for more coverage
...
• Confusion about why the buckle has two different colours
...
• Brand designs are humorous and popular, but may not be suitable for all homes due to HOA regulations
• The use of a NAS (Network-Attached Storage) VM for home users, including tormenting and running server software
...
• Discussion of exceptional individuals, including Tom Merritt and Chris Peril lo
• Analysis of a past episode with Chris Peril lo's guest appearance
• Appreciation for sharp wit and humour in interactions with others
• Debate on the value of certifications like Compton Plus
