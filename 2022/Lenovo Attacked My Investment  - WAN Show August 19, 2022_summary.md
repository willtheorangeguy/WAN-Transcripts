...
• Use of precedent in court cases regarding product defense
...
• Review of the sweater's design and color
...
• Mention of a discount on a Swacket and scarf purchase
...
• Comparison to VTubers and Second Life's user base
...
• The person mentions using a VR tool to create a full-body streaming model for Beat Saber
...
• The chance of hiring a "really good" person versus a "high" person increases with the size of the company due to the larger pool of applicants.
...
• They mention that their current favorite phone is the Note 9 due to its complete feature set and iris scanner
...
• Xplit is mentioned as a sponsor, offering an all-in-one streaming and recording application for content creators.
...
• Misremembering of previously discussed domain names (labs.com, labs2cents, etc.)
• Front-runner being lab32.com due to its brevity and ease of use
• Inspiration behind the number 32 (system32)
• Rejection of other suggestions (lab69, lab64) in favor of lab32
• Checking for conflicts with the chosen domain name
• Mention of a reference to "Lab 32" in the game Chrono Trigger
...
• Stream and comparison drivers: Live stream on Short Circuit or Flowplane, with comparison drivers from major tool manufacturers (e.g., Vera, Klein, Snap-on)
...
• Linus's experience as a product manager at NCIX
• Principles learned from working at NCIX, including taking care of customers
• Damage to brand reputation over small sums of money
• Discussion of an incident where NCIX charged a customer a 15% restocking fee for returning a new motherboard with no issues, despite the store having previously opened the packaging.
...
• The company often has to mold applicants from different backgrounds into sales role positions
...
• Convincing a sister to let their child buy a gaming console (NISA) in the future
• Parental controls for limiting screen time on the console
• Benefits of video games, specifically Minecraft
• Comparing Floatplane to YouTube, discussing development budget and feature differences
...
• Query about the time it took to become expert at Beat Saber and receive Expert Plus badge
• Upfront payment for creators of evergreen content
• Recurring revenue from ongoing content views
• Comparison to putting cash in a GIC
...
• Epson projector experience and availability issues
