• Nvidia's mining limiter finally defeated by Nice Hash
...
• Possible reasons behind Nvidia's move include:
	+ Relevance in data centres with Arc and Radeon Pro ramping up
	+ Internal takeover by Linux enthusiasts
	+ Steam Deck threat to their market share
• SIMULA streaming to Facebook for the first time
...
• Data centre business being a significant contributor to industry revenue and potential motivation for acquisition
• Test results from an Nvidia A6000 system with four cards, including impressive rendering times
• Discussion about data centre equipment, specifically CPUs and GPUs
• Comparison of GPU prices, with A6000s costing $5-7 thousand each
• Review of Camino's website and its container solutions for data centres
• Explanation of high costs due to increased die area and memory costs
• Mention of potential uses for these systems in video production, machine learning, and filming with Unreal Engine 5
...
• They have started looking into creating a 3D home theatre setup using an HD Fury product
...
• Discussion of early music formats and players, including boom boxes and CD players
...
• The topic of power consumption of top-end GPUs is brought up, with rumours of a 4090 drawing up to 600 watts or more.
...
• Intel's conservative reputation is questioned as they released a Peatier cooler that seemed uncharacteristic of their usual approach.
• The discussion then shifts to Saturday morning cartoons, with one host sharing their favourite shows from childhood, including Looney Tunes, Casper the Friendly Ghost, and DuckTales.
...
• Plans for creating a wall with fan colour GPU postcards from LMG
