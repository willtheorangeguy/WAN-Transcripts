• Valve has partnered with iFixit to offer replacement parts for the Steam Deck and Valve Index VR headset.
• The partnership will make it easier for users to repair and upgrade their devices.
• Valve is addressing some of the initial complaints from iFixit, including difficulty in removing the battery and lack of a modular charge port.
...
• The Steam Deck controller's design makes repairable components accessible, such as individual thumbstick replacements.
...
• Linus shares an anecdote about introducing pre-packaged water cooling tubing at NCIX due to warehouse inefficiencies
...
• Use of black boxes with colorants or labels, possibly by Primo Chill
• Valve's decision not to ship sub-components and the implications of this choice
• The importance of building partnerships with smaller distributors for complex products
• Launch of privateer-branded colored t-shirts after two years in development
• Issues with American Apparel's distribution and supply chain problems
• Decision to dye own raw fabric and create custom colors for t-shirts
...
• Companies with high growth rates, such as Linus Media Group, may have valuations that are inflated due to ebita multipliers, making it even harder for heirs to inherit the company without significant tax burdens.
...
• LeMdOg shares their positive experience with Framework laptops, which Linus is an investor in, and praises their commitment to transparency
...
• Plans to offer postcards as an alternative option, encouraging viewers to color and mail them back
...
• Managing multiple employees with similar names (e.g. Jakes)
...
• Recap of Windows 11 insider preview build 22.55.7 features, including drag and drop to taskbar, color profile quick settings, and more
...
• Epcot and Walt Disney's original vision for an experimental city
...
• Concerns about cult-like behavior in the Lion's Media Group tech community
• Apple SSD performance issues, specifically with data integrity and fsync command
...
• Dr. Ian Cutras' departure from AnandTech after 11 years as senior editor
• Speculation about Dr. Cutras' future roles in the tech industry
• The potential for tech journalists to work for companies they cover, and efforts to reverse this trend at AnandTech
...
• Discussion of a recent NewEgg scandal involving unpaid video sponsorships
...
• The importance of upscaling techniques like DLSS, FSR, and XESS for future graphics rendering
• Austin D's experience working with NCIX and how it led to his current position
• How Austin D got started at NCIX, initially as a customer who "sweet-talked" his way into the RMA room
• The story of how Austin D became an employee at NCIX due to his active participation on their forum and his "fire" in discussing technical topics
