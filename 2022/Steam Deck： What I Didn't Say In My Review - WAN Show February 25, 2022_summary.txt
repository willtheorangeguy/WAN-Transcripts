...
• The voice chat feature was compared favorably to Discord, and the possibility of switching to it for remote shows is considered.
...
• Valve is taking on a more console-manufacturer-like role with the Steam Deck, providing an install base and promoting games
...
• Fable is mentioned as one of the speaker's favorite games, which they were excited to play on the Steam Deck but encountered issues with screen artifacts.
...
• Concerns about thumbstick quality, but difficulty finding better alternatives
...
• Sponsorship announcements:
	+ Linode cloud computing service
...
• Nvidia has been hit by a cyber attack, with parts of its business compromised
• Unclear if data was stolen or deleted in recent cyber attack, with security experts concerned about potential attachment to driver software package
• No suspects identified for the attack, but timing raises suspicions of a Russian cyber attack on Ukraine
• Anonymous leaks a Russian Ministry of Defense database, containing mostly emails and names
...
• The speaker discusses a gaming-related project, mentioning various options and ideas for features such as anti-aliasing, bump maps, and chroma sub-sampling.
