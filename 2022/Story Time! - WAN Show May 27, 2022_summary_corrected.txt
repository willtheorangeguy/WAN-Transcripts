• AMD's Ry zen 7000 CPUs launching this fall
...
• Comparison of different smart light switch brands (GE, Luton)
...
• Difficulty finding the firmware download on Task's website
• Google autofilling search queries but not providing useful results
• Contacting Task's product support via phone and live chat
• Receiving response that updated firmware is available, but unable to upload it through Home Assistant
• The speaker is frustrated with a company (Vasco) for not providing firmware updates to their device, despite the updates being available and necessary for proper functionality.
• The speaker feels this is an anti-consumer action and a result of Vasco's proprietary firmware policy.
...
• The speaker criticizes Vasco for using a model similar to telecommunications carriers, where manufacturers write software but then rely on third-party gatekeepers to decide who gets updates.
• The speaker suggests that if Vasco employees are unhappy with their job, they could easily find new employment with better pay and benefits.
...
• The speaker had issues with TASK's product, specifically with firmware updates and support.
• The company's incompetence or ignorance led to the speaker wasting time and resources trying to integrate the product.
• The speaker feels that TASK is being oppressive by not sending firmware updates directly to users.
...
• The company's behaviour could be an opportunity for them to change their ways and become more user-centric.
• Issues with Task smart switches, including faulty firmware
• Desire to replace Task switches with more consumer-friendly alternatives
• Potential sponsorship from Innately or other companies
• Discussion of feature requests, such as instant on/off mode for smart bulbs
• Plans to create a second follow-up video addressing the issues with Task switches
• Discussion about creating an attention-grabbing YouTube title to prevent firmware problems with Task switches
• Introduction of a new merchandise, a headphone t-shirt, on the LTT store
• Running promos and free shipping for orders over $89.99 with discount code "Honour"
• Explaining the business model and goal of LTD store to fund lab equipment through self-sufficiency
• Mentioning future plans for the lab and potential testing methods or methodologies inspired by a visit to the Intel Dev Centre
...
• T-Mobile killing off email 2FA in favour of SMS 2FA
...
• Review of Firewall, a user-friendly networking device
• Recommendation for a NAS brand (True NAS)
...
• Reflection on the sweet spot of technology where it's still "Jacky" but has an enthusiast core
