...
• USB IF guidelines for labeling USB cables with maximum data transfer rates and power delivery capabilities
...
• Unboxing of the host's new shoes (Schrodinger's shoes)
...
• Google's abandoned services: Google Pay, Inbox, YouTube Music (13), Google Pixel, Google Fiber
...
• Sponsorship announcements from Keoxia, 45 Drives, and Secret Lab
...
• Controversy over the Urra Ring/Aura Ring video on Short Circuit
...
• Sarah Dici, former developer, was not involved in the cancellation and was cooperative about the change
• New potential name for the project: lttlabs.com (a domain already owned by the team)
• Lab 64 was also a cancelled project
• Discussion of dbrand's lab 69 product, which has issues with magnet-induced fan speed changes on Steam Deck devices
• Valve has switched to using unaffected Hua Ying fans in production, but existing products may still have issues
• Dbrand's magnetic kickstand issue causes problems with Steam Deck's fan
• Dbrand suspending sales of their magnetic kickstand due to this issue
...
• Details about the bird's behavior and attempts to socialize with people
...
• Discussion on Ryzen 7000 vs 13th Gen CPUs, including performance, price, and upgrade paths
• Upgrades to Ryzen and Intel CPUs
...
• The interviewer and Dennis were aware of each other's presence before filming began, which affected their behavior during the exercise.
...
• Question from anonymous about Luke's favorite member or guest on the Yard Podcast
...
• Possible exceptions for mature business endeavors structured like traditional media companies
• Reviewing budget computers with integrated GPUs (iGPUs) vs standalone graphics cards
...
• Fixing wrinkles in the podcast set and removing GoXLRs
...
• They had supportive teachers, particularly Mr. Trattle, who encouraged their interest and helped them progress quickly through computer classes
• They created their own curriculum with the help of Mr. Trattle and learned advanced development skills, including 3D game development
...
• Discussion on Razer's new handheld console for streaming
