...
• Discussion of why alternative solutions such as floatplane are not stepping in to fill the void left by OnlyFans
• Mention of existing competitors and new entrants in the space, including Bellessa and their planned adult streaming platform
• Concerns about exploitation and safety on OnlyFans
• Comparison of OnlyFans with other platforms such as Patreon and Balesa
...
• The importance of diversifying revenue streams is discussed, with examples including YouTube memberships and behind-the-scenes content on floatplane.
...
• Intel's XeSS super sampling has two versions: one designed for XC GPUs and another that uses common instructions on modern GPUs.
• Arc Silicon runs Forza Horizon 4, Metro Exodus, Crisis Remastered, and other games in an Intel trailer, but no performance metrics are shown.
• Intel will use TSMC's six nanometer process for Alchemist chips, competing with other companies for allocation.
...
• Sponsorship announcements for Build Redux and Elgato
• Discussion on Epic Games' game mode in Among Us and lack of credit to the original developers
• Criticism of Epic Games for copying ideas from other games, specifically comparing their actions to their past behavior with Fortnite
• Comparison of Fortnite's origins as a copycat game to its current behavior
...
• League of Legends and Dota are mentioned as examples of games that have been accused of being rip-offs, but were able to carve out their own niches
...
• LTT store lanyards are now available in various colors and can be ordered on lttstore.com
...
• The host, Linus, has been testing out different lanyard colors for LTT and thinks they're high-quality and worth the price
...
• Color popularity for new lanyards
...
• Discussion of top-selling colors of new lanyard, with royal blue and purple as the most popular choices
