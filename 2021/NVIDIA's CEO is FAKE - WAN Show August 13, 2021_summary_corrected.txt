...
• Nvidia has responded to claims that nearly all the keynote was fake, saying only 14 seconds were real
...
• Examination of mannerisms and behaviours that might be indicative of a real person vs. a simulated one
• Use of machine learning and motion capture (mobcap) to create realistic simulations
...
• Mention of using motion capture (mobcap) actors and machine learning for improved results
...
• Mention of a specific example using Jensen Tackles from The Wheel of Time series
...
• Brands and retailers often bundle products to mask overprice ness or undesirability of one item.
...
• Explanation of the difficulty in taking action against companies like New egg and Gigabyte due to lack of material harm
...
• New egg reviews show similar results, with 54% negative ratings
• Other brands' power supplies (VGA and Sea sonic) have lower issue rates
...
• Sponsor spot for Build Redux, a PC builder that offers affordable upgrades without up charge prices.
...
• Recommendation to change the pH of finger oils or buy a different colour
...
• The host is discussing a possible change to float plane supporters and early access content
• Discussion about the float plane tech stack and its complexity
...
• Requests for recommendations on tech-related topics:
 ...
 • Advice on choosing between Samsung S21 Ultra and Z Fold 3
  • Recommendation between Unpaid and Proxmox for NAS use
• Working on women's sweats
• Upcoming show schedule and channel information
• DAFCO discussion postponed to next week
