...
• Windows users may be confused by Linux features like Winget
...
• The upcoming AMD AM5 socket will use a LGA 1718 design with pads on the CPU and pins on the motherboard
...
• AMD not moving forward with Gen 5 on Ryzen platform, Intel's Alder Lake to support it
...
• Example of Apple's data center in China and compromise of user data security
...
• Criticism of companies like Apple for compromising user data in favor of entering Chinese market
...
• Introduction to and explanation of Winget, Microsoft's new package manager for Windows
• Comparison with other package managers like Chocolatey
• Benefits of using Winget, including batch installation, source verification, and parallelization
• Critique of the Windows Store and potential impact of Winget on its usage
• Personal opinions on the usefulness of Winget for average users vs. power users
• Using Winget to install programs on Windows
• Speed and ease of use compared to traditional installation methods
• Next generation Windows, codenamed Sun Valley 21 H2, expected in fall 2021
• Features of next generation Windows, including WinUI 3 integration and rounded corners
...
• Request to show the host's bulldogs, Burb, in a video
...
• Showcasing Burb's bulldogs and their behavior during a stream
• Idea for a "Scrapyard Wars" segment using pre-2010 parts
• Update on AMC (GME) stock and warnings against investing in it
...
• Beat Saber challenge with David, a friend who claims to be good at rhythm games
• Beat Saber competition with another player
