...
• Criticism of Bobby Ko tick's response to employee accusations
• Union busting
• Cosby suite at Blazon
• Alleged predatory behaviour by Alex Afrasian
...
• Discussion about the defence attorney for someone accused of sexual harassment
...
• Discussion of the company's ratings on Get App (4.5/5) and Google Play Store (4.5/5)
• Promotion of Graphic, an automated phishing defence solution
...
• The sponsor, Graphic, discussed its automated phishing defence solution for organizations
• Sea sonic power supplies were also promoted, with features including quality and long lifespan
...
• A experience is shared about a collab gone wrong, where a representative from another creator seemed insincere in their enthusiasm for a collaboration.
...
• Sony's solution for colour matching and keeping records is highlighted as a better option
• Comparison between The Wall system and projection options using Christie projectors
• Christie projectors offer 4k 120 Hertz and fibre coupled projection heads for remote light sources
...
• Reviewing experiences with a projector in a home theatre setting
...
• Wolf ire Games files an antitrust lawsuit against Valve over Steam's dominance and pricing policies
...
• The host compares Valve's business practices to Microsoft's, noting that Valve's defence is becoming less tenable with the introduction of the Steam Pad
...
• Framework's laptop design is highlighted for its open approach, including easy repairability and degradability of components
...
• Discussion of a verbal contract with the community regarding principles such as repairability, degradability, and openness
• Comparison between LTT and Noctua's business arrangement for an LTT branded product
• Suggestion from Citrus Notes to invest in a company outside the tech industry that aligns with one's passions
...
• Collaboration with other creators, such as Lewis Grossman, and maintaining independence
