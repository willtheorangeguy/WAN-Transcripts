...
[27.48 → 35.60] details of that in other news Western Digital appears to have pulled an data swapping out
...
[55.22 → 62.10] development time there nice also TSMC has raised their prices by up to 20 and so
[62.10 → 70.52] has like global foundries USMC SMIC UMC just everybody raising prices across the board electronics
...
[86.30 → 110.88] and the show is brought to you all today by our sponsors PDF element secret lab and green man gaming
...
[198.62 → 204.38] to the Windows 11 system requirements and there are some good takeaways here and there are also some ones
...
[256.14 → 264.22] apps design principles including the surface studio 2 and intel's core x series and Leon w series so those
...
[271.98 → 280.30] dozen CPU which uh last time I checked was really not that long ago I mean when did the dozen 1600x launch
...
[298.86 → 306.38] one of the ones that we just listed so basically most of them you are plum out of luck specific dozen
[306.38 → 315.50] 2000 series CPUs are unsupported as well, so specifically this would be ones like the 2200g and 2400g if i
[315.50 → 322.62] recall correctly those are not zen 2 based those are like zen plus or something like that is they zen
...
[372.14 → 380.30] results though like do their crash numbers apply to all seventh gen CPUs or like so here
[380.30 → 386.86] basically this is an imager capture of what they mean by that, so reliability means devices that do not
[386.86 → 393.58] meet the minimum system requirements had 52 percent more kernel mode crashes sort of raises a question who
[393.58 → 399.66] is that on is that on is that on Microsoft or is that on the device the person who didn't upgrade their
[399.66 → 406.14] computer devices that do meet the minimum system requirements had a 99.8 crash free experience
[407.58 → 414.30] okay security Windows 11 raises the baseline blah blah blah etc compatibility people continue to
...
[459.90 → 467.34] Facebook now or what but as far as I can tell it's just gone oh um if you message Jon maybe he can
...
[492.38 → 499.02] should have a newer computer but if you install Windows 11 clean from just from an USB thumb drive
...
[546.46 → 557.98] but I think the big takeaway here is not the method by which Microsoft is allowing Windows 11 to be installed on older hardware
...
[580.62 → 590.94] a pirated copy of windows by just upgrading it through multiple versions of windows um with that said so it sounds like
[590.94 → 598.06] like they're trying to shed a lot of that dead weight that upgraded their cracked versions of Windows 7
...
[627.02 → 633.82] of a nothingburger in terms of performance upgrades from what we saw at least for gaming there's no real
[633.82 → 639.18] reason for you to be worried about this in any way because you can still install it clean if you really
[639.18 → 646.86] want to and probably the best way to pirate windows is the official way which is to just
...
[657.18 → 663.98] and set as desktop background that's that's probably the easiest way to pirate windows these days
...
[679.02 → 687.98] it um also because i actually I finally activated the windows install on my home desktop Luke i I did too
...
[734.14 → 739.18] float plane chat says DIY upgrades are such a small segment of the market they don't care about us, they're
[739.18 → 744.22] drawing a line to maximize the amount of average users they can sell a new OEM license to honestly
[744.22 → 751.10] I don't even think Microsoft is after selling new OEM licenses I don't think so it's its not it's not
[751.10 → 758.54] that many I mean it's a lot to be clear like here let's let's pull up let's pull up Windows 10
[758.54 → 766.62] on new egg okay here we go here we go all right Windows 10 this one right here is the number
[766.62 → 779.82] one bestseller in operating systems that makes sense whoa 1382 reviews now that's a lot you know
...
[799.18 → 803.50] um especially when you factor in that there are other avenues by which Microsoft can directly
[803.50 → 810.14] sell windows to users and there are other stores other than new egg but in the grand scheme of things
[810.14 → 817.82] okay let's go look for a dozen 5600x CPU okay so let's go take one probably the most popular yep there it
[817.82 → 829.66] is the most popular desktop CPU holy smokes 1766 reviews for this thing something here doesn't
[829.66 → 839.98] compute there's only like what maybe so we got which Windows 10 so we got 64 bit OEM we got
...
[882.78 → 888.94] is not as big of a deal as you might think what Microsoft is trying to do is they're trying to drive
...
[922.38 → 927.34] I mean i I think I suspect they realize that there would have been people would have found a
...
[938.46 → 943.42] 11 is going to be you know this is the most reliable window ever this is the most secure window ever
[944.86 → 951.10] in other news speaking of reliability Western Digital has apparently pulled an data
...
[967.02 → 975.18] the so 8100 or 8200 I can't remember exactly the model yeah the model of SSD, but we had our community
[975.18 → 980.06] submit, and we actually paid them for them, we bought them for I think it was like twice the market rate
[980.62 → 986.70] to make it worth people's time to reformat their machine but we bought these a data SSDs from
...
[998.62 → 1006.62] common with each other and when you consider that a SSD is just a controller a dram cache assuming you get a
...
[1082.14 → 1090.06] they don't understand why with a 12 gigabyte SLC cache so if you guys aren't familiar a SLC cache
[1090.06 → 1098.38] basically takes a component of your NFC or TLC or PLC NAND so that's how many bits per cell are being
...
[1120.30 → 1126.78] all right so that SLC cache superfast but it's great for you know if you're installing
[1127.42 → 1132.70] photoshop or something like that that's going to happen real fast as your CPU can keep up with
[1132.70 → 1139.34] decompressing the files and uh feeding the SSD with data to write the problem is that as soon
[1139.34 → 1145.50] as you go to do something heavy 12 gigs is actually not that much in the context of let's say for
[1145.50 → 1153.90] example installing a Vida game like Luke off the top of your head okay can you think of any games that
[1153.90 → 1161.10] are larger than 12 gigabytes hit me with one i can think of a game that's 10 over 10 times bigger
...
[1177.02 → 1184.46] you're doing fits within them everything is hunky-dory everything's fast but once you are the and
[1184.46 → 1192.78] then and then once the drive is idle it'll flush that cache slowly over time right out to the uh
[1193.34 → 1200.46] less performance you know TLC or PLC operating mode NAND all right so if you were to go and install a
...
[1258.62 → 1266.78] that WD has ever had egg on their face for not for improperly labelling a drive I mean do you guys
[1266.78 → 1273.82] remember that whole shingled magnetic recording scandal it's a ring spell didn't WD issue a previous
[1273.82 → 1282.54] statement WD statement shingled drives let's see if I can find it WD admits two to six terabytes WD red
[1282.54 → 1288.78] NAS drives use shingled magnetic recording which is terrible for NAS operation let's see if we can
...
[1334.54 → 1347.42] so I guess that's um something uh, so this is at least they didn't break their promise since
...
[1375.98 → 1384.14] read into the marketing but also when the marketing is just a specification you're not supposed
...
[1390.78 → 1397.50] it's its a fairly boring product yeah that I think a lot of people want to be able to buy off of
...
[1446.78 → 1451.90] afford their best, but it's all by this knowing that I can trust it when you pull a move
[1451.90 → 1453.74] like this you erode that trust
[1457.02 → 1466.06] oh right and in other news Samsung actually pulled a similar move so the legendary 970 Eve plus
...
[1481.58 → 1490.54] silicon shortage and because of the covert restrictions the factory that makes the controller in the 970 Eve
...
[1567.66 → 1575.10] and they expected us to just keep keeping buying the 970 Eve plus thinking that it's still the same drive
...
[1594.54 → 1603.50] crucial has crucial ever pulled uh a SSD you know what i I think they have that kind of
[1603.50 → 1610.30] that kind of rings a bell I think crucial has probably changed NAND although I don't
...
[1633.10 → 1638.54] they're okay but apparently not black dark storm asks what about Sabrina I don't think Sabrina has
[1638.54 → 1646.46] managed to attract any controversy yet but Sabrina unlike a lot of these other companies WD crucial
...
[1660.94 → 1669.50] finished product um this news is from this month oh crucial yeah this was August 16th
...
[1684.94 → 1690.46] because no one cares about the spec of a SK Hynix drive they care about the spec of the computer so as
...
[1701.82 → 1708.06] their p31 this is off the top of my head sorry their p31 is superpower efficient so in terms of
...
[1721.50 → 1728.70] don't have the recognition in the consumer space uh max the seven on float plane says I mean
[1728.70 → 1735.02] Samsung had literally been pushing their 980 d ramless SSDs on Amazon as equal to their Eve and pro lines
[1735.90 → 1746.70] yeah that's uh that's fair Scotty says Peoria I don't think Peoria has been nailed um I don't think so
[1747.82 → 1756.22] or even to Shiva pre Peoria I mean one of the companies they acquired definitely ran afoul of uh these kinds of
[1756.22 → 1761.82] uh these kinds of guidelines we're providing you know don't change products without telling the
[1761.82 → 1768.86] consumer the Peoria or Toshiba acquired Oct way back in the day and they they definitely
[1768.86 → 1777.10] had issues yeah that was yep just a few um SK Hynix is there is their public popularity more of a north
[1777.10 → 1785.90] American thing like the lack of it you mean yeah that could be um I know that they've been
[1787.66 → 1793.50] if you remember when I was trying to get my like my ram and drives for my previous Geodude system
...
[1808.06 → 1815.42] popular elsewhere might just completely not be I don't know new egg has almost no reviews for pretty
[1815.42 → 1822.78] much anything SK Hynix but the gold p31 that SDI alluded to before um has almost a thousand ratings on
...
[1863.26 → 1868.22] you get Samsung chips because if you get the SK Hynix version your ram won't overclock as well
...
[1880.06 → 1885.10] like I don't even think they have a gen 4 drive, yet they're they're going slow and steady wins
...
[1945.82 → 1956.14] discount games or really just any games the show is also brought to you by pdf element allows you
...
[1974.86 → 1979.58] digital signatures to help recipients validate document authenticity and integrity and of element is
[1979.58 → 1985.26] currently offering a back to school sale so get up to 50 off PDF element at the link down below
[1985.98 → 1990.22] finally the show is brought to you by secret lab chairs are engineered to keep you
...
[2013.50 → 2022.14] a secret labs chair but I can say that I have a lot of experience with the product, and it's perfect
[2023.18 → 2030.06] they make great chairs, and they are my favourite chairs there are a lot of gaming chairs out there that
[2030.70 → 2040.22] suck um i I mean man back when we were reviewing gaming chairs I was amazed at how same they could
[2040.22 → 2048.22] look yet how different they could be like a Nazi comes to mind as one that looks fine but is incredibly
...
[2060.14 → 2066.70] who knows maybe they're better now the point is I know for sure secret labs products perfect um
[2067.34 → 2073.90] did i just close my doc that had all my notes in it that's uh this is really awkward this
[2073.90 → 2079.34] is going great this is the best sponsor read I've ever done they're definitely gonna work with us again
[2079.34 → 2085.26] so I think this is the first time we've worked with them too okay the point is their new titan Eve 2022
...
[2125.34 → 2132.86] Ltd store hey the Linus selfie mouse pad and the sad Linus desk pad uh these are kind of meme
...
[2173.90 → 2180.70] Memling it up guys enjoy limited time only at the same time if you want uh the original
[2180.70 → 2188.30] mouse pad the northern lights desk pad there are uh a ton of sizes a ton of new sizes tiny ones
[2188.30 → 2196.62] huge ones there's one that's 1500 by 900 it's basically a yoga mat almost um dangerously
[2196.62 → 2202.54] close it's actually pretty close to the limit for weight that we can ship internationally without
[2202.54 → 2210.62] incurring like enormous shipping fees wow so yeah it's its really it's like huge and really heavy
[2210.62 → 2216.70] all right let's move on to another topic what else we got Luke hit me uh there are some interesting ones
[2216.70 → 2221.82] in the rapid fire section we could talk about only fans um only fans reverses their decision
...
[2238.70 → 2245.26] uh psych never mind everything's fine um the this change is coming yeah less than a week after
...
[2268.62 → 2275.66] uh yeah a little bit the considering the point industry is worth billions of dollar estimates say
[2278.06 → 2284.70] six to 97 billion what that's a big range that's a massive range uh there is clearly someone out there
[2284.70 → 2289.82] willing to pocket transaction fees yeah of course um I mean this is something that we know
...
[2306.70 → 2312.38] I can you talk a little bit about what that looks like they're really expensive um and they
[2312.38 → 2317.26] they always have been really expensive because they kind of know it's it they're in a weird spot
[2317.26 → 2323.90] because they seem to understand that if you are talking to them, you have to be talking to them
[2323.90 → 2329.82] um right, and it's its I don't know how many market segments are like that where like you're the not
...
[2345.90 → 2353.18] can be pretty bad uh the support on the back end um the developer friendliness of it um
[2354.06 → 2359.02] compliance to different browser things there 's's a lot that can be very annoying um so you
[2359.02 → 2363.90] gloss over that stuff, but that's fascinating stuff that I think the average person would not know
...
[2377.02 → 2383.82] use are from a very small grouping of payment processors that are very clean uh you generally
[2383.82 → 2390.46] only deal with like Amazon payments google payments apple payments uh Shopify is actually really
[2390.46 → 2400.86] massive um stripe and PayPal or PayPal trading as Braintree um and there isn't like a ton outside
[2400.86 → 2406.62] of that there's some Ebola stuff if you did uh twitch back in the day and there were problems with that
[2406.62 → 2410.94] and that's part of the reason why that's being phased out as far as I can tell uh and some other
[2410.94 → 2418.78] things but like it's its really annoying for everyone involved if the payment process is not basically
...
[2441.74 → 2450.62] cancelled a subscription and then I had to fight for a refund um let's see here uh yep uh pan
...
[2464.78 → 2471.02] so that's even more of like yeah like why deal with difficult things a lot of a lot of uh
...
[2490.54 → 2496.94] mean i I wonder if there's I wonder if there's actually like a like a historical sort of
[2496.94 → 2504.46] record of this like first nude picture on the internet that was probably really early I'm suspecting
[2504.46 → 2511.50] there's got to be there's got to be what is this what is this useless page here what am I looking
...
[2621.90 → 2630.38] platform it's I mean how do I put this there's only so many hours a day that you could comfortably
[2631.02 → 2639.74] you know enjoy pornography i i think i I think okay look don't don't quote me on
...
[2659.58 → 2666.46] you to go do something safe for work at the same time so it seems like they misinterpreted that
[2666.46 → 2674.30] momentum in safer work content as sort of change in their identity as a platform but what it actually
...
[2704.54 → 2708.78] I mean that was the way that we were planning to address adult content, so there's no
[2708.78 → 2714.94] reason they couldn't do the same thing reverse yeah, and you can use your adult content platform to
[2714.94 → 2719.26] get that sister site off the ground absolutely instead of driving people
...
[2755.82 → 2759.58] there's probably some there's probably some I'm not 100 certain but I'm I'm pretty sure there's
[2759.58 → 2764.06] some issues there because it's a different you have different agreements on both sites' oh that's that's
[2764.06 → 2770.62] yeah that makes sense yeah uh in other like in terrible news how about we just put it that way
[2770.62 → 2779.02] TSMC will be raising their prices by up to 20 this comes courtesy of Tom's hardware and the Wall Street
[2779.02 → 2787.98] journal uh yes my friends that is how mainstream this bad news is getting world's largest chipmaker to
...
[2796.14 → 2804.94] seven nanometre and smaller wafers will increase as much as 10 percent while 16 nanometers and larger
[2804.94 → 2813.18] nodes will increase by 20 percent for all orders set to be fulfilled starting in December TSMC's yeah go
[2813.18 → 2820.54] ahead I just said real like it's its coming up basically now yep by the time if you were hoping that
[2820.54 → 2827.26] you know the shortage would go away and prices would fall it looks like by the time that would
...
[2846.46 → 2855.66] every anyway right TSMC's n5 and n7 fabrication was 49 of their 13.29 billion in revenue in the
...
[2864.86 → 2871.66] could see increased prices in the near future as well as ASIC manufacturers like bit main TSMC isn't the
[2871.66 → 2877.82] only one though global foundries USMC SMIC and UMC have all increased production prices recently and
...
[2890.14 → 2897.90] space and the worst part of these guys is these numbers we're quoting you 10 20 you will be lucky
...
[2920.70 → 2927.34] product once all the middlemen and stakeholders and packaging and marketing and blah blah blah blah blah
...
[2972.46 → 2977.26] yeah kind of crazy that it's across the board this also like we saw the GPU shortage kind of
...
[2988.06 → 2995.34] here to stay yeah and the thing is that prices are whatever the market will bear and NVIDIA had for
...
[3022.78 → 3030.14] except for one small detail that's the 680 used their what what what was 680 maxwells
[3030.14 → 3037.98] the firm fire then Kepler I don't remember the point is it used their next tier down you didn't
...
[3045.98 → 3053.58] were effectively selling you like a high-end rather than enthusiast end GPU for the same price that the
...
[3087.90 → 3096.78] surprised if we ever see another top tier GPU for you know 699 749. i i think those days are
...
[3109.90 → 3113.82] kick it off uh you can run through the topic because this is something you're a little bit
[3113.82 → 3121.82] better versed in than me but I want to kick it off by saying to everyone who uh defended apple's behaviour
[3121.82 → 3129.10] and said that apple is not a monopoly and the app store is just uh their playground their rules
[3129.10 → 3139.26] um this is apple's admissions essentially that you're wrong their behaviour was bad, and you are
[3139.26 → 3147.18] actually wrong, and you need to go read go read about antitrust go read about anti-monopoly
[3147.18 → 3154.78] laws go read please because I am really I have gotten so many frustrating stupid tweets about this
[3155.50 → 3162.78] every time I talk about it, I just get these horrendously bad takes apple's behaviour is bad it's
[3162.78 → 3168.46] terrible and the fact that they're settling this the fact that they're settling this to the tune of
...
[3204.30 → 3210.54] customers about alternative payment options outside the app this is very good very happy about that
[3210.54 → 3215.34] that's like the core thing for us that's the main thing we're excited about um they can however
[3215.34 → 3220.70] use contact information gleaned from the app now with permission yeah yeah whatever um they are also
[3220.70 → 3225.26] establishing this is the part that's like a little odd for me and I haven't dived far enough into
...
[3383.98 → 3392.78] these suits because uh they basically get to go after a nice juicy vein uh to suck onto
...
[3403.18 → 3410.06] end users who were affected by this in some meaningful way in a lot of cases um I mean I've seen
...
[3426.46 → 3433.98] like 300 grand, and then you know two dollars each to the know what would that like five dollars each to
[3433.98 → 3440.78] what would that work out to like 100 000 people 120 000 people affected it's like okay
...
[3464.70 → 3472.14] it's not technically out to lunch which is kind of nuts um and while some people are
[3472.14 → 3477.58] trying to style on the lawyers for doing this and the fact that they have four pages of reasons why
...
[3511.50 → 3519.58] might help the like epic case which is more the one that we're actually hoping to go through so
[3519.58 → 3525.98] yeah we'll have to see a long time though because epic will epic is asking for a lot more than these
[3525.98 → 3532.30] developers were uh there are some hilarious stories in float plane chat uh Alana Kantian I think
...
[3544.94 → 3549.82] for a dollar 25 or something from a class action about a company using robot diallers
...
[3564.22 → 3570.54] um part of the payout is you know we're yeah you're right uh they're going to say no we didn't
...
[3589.34 → 3597.10] said or not does say something about uh how vulnerable they think that they are right now and
...
[3609.90 → 3617.58] developers speaking of yeah i would have liked more stuff in there that helps the app developers in
...
[3671.66 → 3676.70] overlooked this thing, and it happens to brick it when you unlock the thing it's its definitely on
[3676.70 → 3686.30] purpose, and it's just like I understand blah blah Samsung Knox blah blah security, but the fact is that
...
[3697.82 → 3705.50] um so CCA senior members' oh boy uh white bear is I think the direct translation from the Chinese name
...
[3721.02 → 3727.74] without precedent Sony pulled this with their Peria devices um if you unlocked the bootloader of
[3728.22 → 3733.58] any Sony Xperia device it would result in nothing but green pictures other software features like
[3733.58 → 3737.90] Sony's video and audio enhancements were similarly worked I would have to assume that this is to
...
[3799.50 → 3806.38] so I have a screen recording of super chats coming in the chat on the right and then the viewer
...
[3822.70 → 3828.70] first ever pc um what should I go for a good experience well you should watch one of our build
[3828.70 → 3834.70] guides, and then you should post on the Linus tech tips' forum in the new pc a new build section
[3834.70 → 3839.42] people will help you find the right components for your budget and for what you're trying to do
...
[3861.02 → 3868.54] to get at um the new as far as my understanding goes those laws only apply to systems sold not new
...
[3911.02 → 3918.22] why I made that decision uh Matt shark says I've built several e-commerce sites and developer
...
[3953.10 → 3961.34] a hundred if I recall correctly they are 30 80 tis coming from I think it's MSI don't quote me on that
...
[3985.58 → 3990.46] reshape the chipmaker landscape and make the future brighter as a whole it's possible but the
...
[4006.70 → 4010.06] I don't think the intention is to overproduce and drive down prices sorry
...
[4030.86 → 4039.10] all time um no I can't say I did thanks arm uh Palladian and zero two says hey guys I need some more
[4039.10 → 4043.26] ports on my router it only has four what do you recommend adding more that is such a simple tech
...
[4054.86 → 4059.42] nope I have never done that like i just glossed over that
...
[4104.06 → 4111.98] bandwidth so all those devices will now share the uh one gigabit probably um that the one port on
...
[4124.14 → 4129.42] all connected to the little five port switches they can communicate with each other at full gigabit speed
...
[4140.94 → 4149.18] link potentially bottleneck linked and that's if it's the end of the wan show we will see you again next
