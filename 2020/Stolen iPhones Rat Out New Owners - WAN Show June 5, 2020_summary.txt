...
• Intel's Xeon processor and AMD's RDNA 2 Big Navi are discussed as upcoming tech releases
• Apple has been locking stolen phones
• NCIX US website is back online
• LTX emotes are still available on Floatplane despite the platform's closure
...
• Recovering a "yote" (disposed) phone
• Discussion about looting and property damage
• Legal ramifications of taking something from a broken store
• Narrator's anger towards neighbor, smashing their car window
• Atonement for damaged property (temporarily driving/towing neighbor's car)
...
• A neighbor's car is taken and returned with repaired windows, leading to a discussion about morality and consequences
...
• Comparison to NCIX's past products and branding
• Possible use of third-party software (SimTech)
• Speculation about the origin and authenticity of the demo store
• NCIX's SKU numbering system is not referenced
...
• NCIX was custom-coded platform, now moved to CS-cart.com
• Discussion on database fields for SKU, vendor part number, description, color
• Issues with in-stock tracking and inventory management at NCIX
...
• Reviewer's personal experience with a Maxonomic chair in his office
...
• AMD's RDNA 2 Big Navi release date and implications
• AMB CFO Devinder Kumar's statement on AMD's GPU roadmap
...
• Discussion about the benefits of AMD's (or "big Navi") success for the gaming industry, including improved hardware and visual fidelity in games
...
• Details about Intel's Xeon 10 nanometer processor with rumored support for PCIe 4.0 and DDR4-3200
• Geekbench 4 test results showing the Ice Lake chip scoring 4,100 points single-threaded and outperforming previous models
...
• Utilizing local arcades as data centers for cloud gaming
...
• Idea of renting or contributing excess processing power from neighbors or others
• Discussion of Starlink and fog-style gaming
• Explanation of the speed limitations of light and fiber
• Mention of Corsair recalling power supplies due to a bad batch in 2019-2020
• Introduction of a new Thermaltake AIO that cools CPU and RAM, with commentary on its design
...
• Zune device nostalgia and discussion of its software
...
• Reference to the "Markiplier E meme" and its application to a person's personality
...
• Analysis of the person's behavior and traits, including talkativeness, outgoingness, and attention to detail
...
• Promotion of Soylent green (the food product)
• Apology for a past incident involving Soylent green and an implication that it might be people