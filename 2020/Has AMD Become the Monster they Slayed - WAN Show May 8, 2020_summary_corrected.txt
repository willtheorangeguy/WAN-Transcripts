...
• AMD releases Ry zen 3 3rd Gen processors
...
• This means owners of older motherboards and CPUs (such as Ry zen 3000 series) may not be able to upgrade
...
• A CPU upgrade path can be affordable, with options like the Ry zen 2600 offering significant improvements over older CPUs for relatively low cost
...
• Discussion of future computer upgrades and purchases (Ry zen, NVIDIA)
...
• Cam is a software that allows users to remove and replace their background without a green screen using AI
...
• A similar approach is taken by Kaine, which allows users to pay on an ongoing basis with support and keep the software after stopping payments
• The Xbox Series X gameplay reveal was temporarily taken down due to backlash over the lack of actual gameplay in favour of intro and interviews
• The majority of games introduced have no actual gameplay, just cinematic or trailers.
• Some games with brief gameplay segments are unclear if they're actual gameplay or cinematic.
...
• Economic modelling to adjust device prices rather than relying on multiple revenue streams
...
• Disclosure of additional leaked information, including N64 and Game Cube source code, legacy Pokémon games, and more
...
• Several VPN services, including Private VPN and Better Net, had critical vulnerabilities discovered
• A proof-of-concept attack server was discussed, and a software download was mentioned.
• Better Net did not automatically install the malicious update, but Private VPN did.
...
• The port was made possible through data gathered from the fan-run Super Mario 64 recompilation project.
• The port may be shut down by Nintendo.
• Discussion of generalizing people with neck beards
• Comments on internet links being dead or circulating online
• References to Nintendo and a potential leak
• Super Chat comments from viewers, including Metal Gappy and Robert May hill
...
• Question about adding a yearly subscription option for OG Float plane subscribers
...
• Proposal to discuss the idea with Mr. Hiroki and potentially implement it through a dashboard update
...
• Reference to Five and his helpfulness in completing the project
• Mention of Five being a "meme lord" and a "walking living meme"
• Comments on receiving unsolicited items, including phone cases, as an influencer
• Personal hygiene conversation between Nick Plum ac and Linus
...
• Criticism of another Twitch streamer (Luke Laugher)
...
• Discussion of improving the comment section on Float plane
• Idea of revamping the comment section to be more similar to a forum like Linus Tech Tips
• Mention of someone offering to buy the Float plane forum but being declined
