...
• Rumors of quad-core Zen 2 CPUs are discussed
...
• The clip was of a person attempting to keep Apple EarPods in their ears, and the speaker remembered requesting a sample for review
• The speaker sent a follow-up email to the creator of the SPRNG product after receiving a return-to-sender package
• The conversation turns to Apple's modular headphones prototypes, which have magnetic earpads and headband padding that can be replaced by the user
...
• Discussion of Luxottica and Esler being the same company
...
• The speaker discusses Manscaped, a product for men's grooming, and its features such as the Lawmower 3.0 trimmer and SkinSafe technology
...
• Researching Senville brand and their products
...
• Discussion of a company's spice rub product (Herba Blend)
...
• Criticism of video as fear mongering and contributing to problem, but predictions turned out to be true
...
• Mention of shuttles (birdhouses) or shuttle cocks as a separate topic
...
• The host discusses a past stream where they built a $800 gaming PC and notes that prices for components have increased significantly since then.
...
• A conversation about the Steam controller patent is then started, which suggests that Valve may be working on a new, modular gamepad similar to the Xbox Elite controller.
• The speaker has a new G Pro Wireless controller with an accidental button press issue
• Rumors of quad-core Zen 2 CPUs from AMD to compete with Intel's Comet Lake S processors
• Potential cost-effective options for quad-core Ryzen 3 processors using defective CCX or single CCX design
• Discussion on the potential performance implications and cache sizes of a single CCX
• Options for users: cheap quad-core Ryzen 3 or higher-performance Ryzen 5, 7, or 9 processors from AMD
...
• Conversation about a person's experience with Anno game streaming on Twitch
...
• Mention of various individuals (Ripster, Joe, Michael, Pablo, D-Man) and their responses to the non-existent book
...
• Discussion of narrating an audio book, with some individuals volunteering to do so
...
• Mention of Noro score sending love from Japan and possible interpretations
...
• Reflection on past experience with Skype being DOS-attacked when discussing video chat services
• Donation from Jason Sintich and mention of the WAN show's title bar movement
