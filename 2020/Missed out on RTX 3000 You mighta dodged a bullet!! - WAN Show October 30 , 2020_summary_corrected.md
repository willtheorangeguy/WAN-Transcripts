• AMD Big Nazi graphics cards revealed
...
• The 6900 XT has 80 Us, 2 GHz game clock, and 16 GB GDDR6 memory, undercutting NVIDIA by $500
...
• The narrator's experience with AMD products being disappointing
...
• Memes and humour about Intel and Nvidia
...
• Discussion on how SAM provides CPU with full access to GPU's memory, but only works with Ry zen 5000 series processors
...
• A Typists and Gamers segment begins, where different colour options are presented for a product
...
• Comparison of the colour of the keyboard to a shirt
• Confirmation that the keyboard is "close enough" in terms of colour
...
• Bacterial growth and the importance of airflow in preventing odour buildup
• A medical procedure that allegedly prevents excessive sweating
• Messi Footwear sponsors the show, discussing their water-resistant and comfortable shoes
• Messi announces a new weekend shoe with a $25 discount for viewers using code WAN show
• LTTstore.com shoe dryer is compatible with Messi shoes
...
• Design allows specific colours to resonate through pixels without hurting brightness
• Display is expected to be brighter with better colour accuracy than existing ones
• It may be a matter of when and where it becomes available, not if
• Amazon's Racer phones have a fingerprint warning due to handling procedures
