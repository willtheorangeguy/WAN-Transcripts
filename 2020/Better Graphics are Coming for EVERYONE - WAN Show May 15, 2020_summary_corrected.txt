...
• Announcement of NVIDIA's A100 GPU, an Ampere-based card for data centres and supercomputers
...
• Mention of a video platform called Float plane and its creator with a beard
...
• Thumb stick positioning on controllers being a significant issue for some gamers
...
• Discussion of sponsorships, including Mans caped and Squarespace
...
• Proposed ideas for improving the sequel trilogy, including:
  ...
  • Adding character development to the Stormtrooper
...
• Inconsistencies in lightsabre mechanics in Star Wars, including inconsistent damage and healing effects
• Discussion of the "o-penis" calculation problem with lightsabres, referring to an inconsistency where Obi-Wan's lightsabre is unable to defeat Vader
• Mention of other Star Wars inconsistencies, such as the physics-defying nature of lightsabres
• Introduction to a new topic: LG's dual-screen phone concept called the "Wing"
• Critique of the LG Wing's design and features, including its swivelling screen and potential flaws
...
• Super Chat topics including:
	...
	+ A request for new merchandise, specifically Wan show shirts
...
• The host discussed a retro gaming handheld console called Overcame and its similarity to the Sega Game Gear.
• The host shared a personal anecdote about his son trying the Game Gear and comparing it favourably to the new console.
