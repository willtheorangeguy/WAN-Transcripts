• Intel HE GPUs rumoured to be released in configurations as hot as 500 watts
...
• Introduction to new hardware from Bessie Footwear, Back blaze, and PIA
• Intel XC Series GPUs leaks and expected release date
• Details on an internal presentation allegedly from Intel's data centre group about the capabilities of Intel HE codename Arctic Sound
...
• Quad-tile cards require a 48-volt power connector and are likely data centre-centric
...
• Comparison with NVIDIA's RTX 3000 series cards and rumoured 75% increase in speed
• Potential use cases for Intel graphics, including data centre applications and machine learning
...
• Personal update about starting a YouTube channel and discussing Float plane's features
• Tech Wiki video upload window will typically be one week, but can be shorter if time-sensitive
• Simultaneous release on Float plane and YouTube is possible in some cases
...
• They mention another popular video, "Screen Melt", which got 8.6 million views but had a negative impact on an employee (Taken)
...
• Hardware as a service (Has) model, where companies like Cisco and Merck charge monthly fees for software upkeep
...
• Sponsorship mention for Messi Footwear
• Product review of Messi Footwear, including its features such as waterproofing, temperature regulation, and flexibility
• Special offer code for Messi Footwear
• Back blaze cloud backup service mentioned as a sponsor, including its unlimited data backup and mobile app capabilities
• Mention of Back blaze's 15-day free trial
...
• Commitment from PIA and its parent company to handle matters responsibly after the acquisition
...
• Back blaze hard drive stats for 2019, with some controversy over their accuracy
...
• Back blaze previously reported on these failures and moved to a different model that fixed the issue
...
• Discussion of an arcane issue with a OEM or U installation
