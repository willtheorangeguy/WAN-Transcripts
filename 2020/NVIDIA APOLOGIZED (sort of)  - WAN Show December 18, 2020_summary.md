...
• CD Projekt Red's recent issues are mentioned as a contrast to Nvidia's apology
...
• NVIDIA's apology to Hardware Unboxed for their behavior, but no explanation or solution
• Comparison of NVIDIA's actions to a parent apologizing to one child after hitting them, without changing their behavior
...
• Controversy over CD Projekt Red's marketing tactics and lack of transparency
• Devotion horror game mentioned as another example of PR troubles for CD Projekt Red
...
• Recently, GOG (owned by CD Projekt Red) also removed the game from their platform, stating they received complaints from gamers, which sparked speculation that CDPR is kowtowing to the Chinese government.
...
• Reaction to CD Projekt Red's changes to Cyberpunk 2077
