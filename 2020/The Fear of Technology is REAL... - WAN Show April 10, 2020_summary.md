...
• AMD's fourth gen Ryzen desktop chips are set to release in September 2020.
...
• The speaker shares their streaming setup and equipment, including Elgato lights and a Rebel T6i camera.
...
• Clarification on what 5G is (not related to millimeter wave)
...
• Analysis of how crossplay has made it less relevant which console to choose, as gamers can now play together across platforms
• Console exclusives and backwards compatibility
• AMD's Ryzen 4000 series desktop processors and Computex launch
• Importance of industry shows like Computex for product launches and partnerships
...
• Upgrading current processors vs waiting for newer models (4th gen Ryzen)
...
• Flowplane updates and new features for tracking statistics and customer support.
• Reopening the gates for new member recruitment on Floatplane
...
• A troll is sent a hundred dollars to move the Wanshow title bar
...
• Gregory Reed asks about limited-run hardware shirts in lighter colors, and the host explains their difficulty in sourcing equivalent quality at a fair price.
...
• Canceling OBS and leaving the event live