...
• A video about cheating in Tarkov went viral and has caused controversy and division in the Tarkov community
• The creator of Tarkov, Goat, cheated in the game to expose other cheaters by creating a wiggle that reveals player positions and inventory
• The revelation has damaged the Tarkov community and gameplay experience
• There is also discussion about an upcoming eSports event featuring lesser-known games
• Valorant's anti-cheat software detects and prevents cheating in Escape from Tarkov
• A video was leaked showing a cheater's perspective in Tarkov, leading to controversy on Reddit
• The Reddit community became "on fire" with deleted posts and moderators trying to enforce the rules
• Creators of Tarkov streaming live were pressured into watching the video and reacting to it immediately
• Some creators reacted negatively to the video, sparking a backlash from the community
• There may be an incentive for some community members to downplay or ignore negative content related to Battlestate Games due to potential perks and rewards.
...
• Cheating in Tarkov is widespread and affecting gameplay
...
• A poll suggests 41% of respondents are considering leaving Tarkov due to cheating issues
• Cheating is not unique to Tarkov and is a problem in many multiplayer games
...
• Replay system for games, specifically Tarkov
...
• Tarkov's open lobby system makes it difficult to prevent cheating
...
• Tarkov's financial reward system potentially encouraging cheaters to remain active
...
• Comparison with Zoomers, who start talking immediately when recording begins
...
• Questioning whether the "millennial pause" is a generational difference or just a matter of tech savviness
• The "millennial pause" is a brief hesitation at the start of some recorded videos
• Zoomers (people born after millennials) don't use this pause in their YouTube videos due to editors cutting it out
...
• Generational differences in consumer behavior and values
...
• Mention of specific games such as Counter-Strike, Dota, and Rocket League not being included in the Olympics' competition
...
• Discussion of a hypothetical situation where two popular games (Dota and League) are combined
...
• Identification of specific games for each sport, including Tennis Clash, Virtual Taekwondo, and Gran Turismo
...
• Mention of other sports and games being considered for inclusion, such as archery, baseball, taekwondo, tennis, chess, and Majong
...
• Discussion about Gran Turismo being a sim-like game, but not as sim-y as others like Project Cars or iRacing
• Comparison of Gran Turismo to other racing games and the possibility of it being too middle-ground
• Suggestion that Gran Turismo could have been more arcade-y like Mario Kart, or completely sim-like like iRacing
• Mention of Forza and Cruisin' USA as alternative options for an esports category
• Discussion about cycling esports, specifically Zwift, and the humor in a rider winning both the actual event and the virtual one
...
• Sponsorship spots for Thorum, a company that hand-makes wedding bands and rings from unique materials
...
• Contents of tech pouch: Thunderbolt cable, angel bird (not used), expandability thingy, LTT screwdriver, needle nose pliers, side cutters, thumbstick cover
• Various cables and adapters, including a "everything" cable and a micro B adapter for Logitech mouse
• Other items in the tech pouch include a lavalier mic holder, medical tape, ykk waterproof zippers, reprieve recycled water bottle material, 2.5 gig network card, external audio sound card, and USB to 3.5mm adapter
• Discussion of various tools, including jeweler screwdrivers, atx pin removal tool, molex pin removal tool, and water cooling fittings
...
• Discussion of future plans, including a possible 24-hour subathon wanshow
...
• Follow-up on previous discussion about monetization and the uncertainty around it
• Personal anecdote about buying merchandise from a creator for support rather than quality
• Question from Anthony Linus about biggest regret in decision-making for LGMT
...
• Discussion of past experiences and memories from old servers and forums
...
• NCIX days and invoice for payment
...
• Austin asks about Linus' favorite part of his home, which is a house with several issues.
...
• SS Thaum's suggestion of a badminton match or creator clash with Stephen He
...
• iFixit partnership with Nokia for creating repair kits and tools for common components
...
• Color options, including silver and black
...
• Mention of Flowplane and its ability to handle DRM-protected content
• Comparison between Flowplane and other platforms, including CBC Gem and Netflix
• Explanation of neural network-based image sharpening and edge detection
• Discussion of live streaming quality using Flowplane
...
• He discusses his work on Apple's XServe line of servers and how they manage hardware obsolescence by no longer providing software updates.
...
• The demise of XServe and its functions
...
• Explanation of why the host prefers bathing over showering after exercise
...
• Plan to open a badminton center and making Whale Land events more regular
• Progress on building a networking and power infrastructure for the badminton center
• Setting up a badminton center and table system in a warehouse
...
• Favorite builds and projects, including the NerdForge PC and copper tubing build
• Robo-taxis as the future of transportation
