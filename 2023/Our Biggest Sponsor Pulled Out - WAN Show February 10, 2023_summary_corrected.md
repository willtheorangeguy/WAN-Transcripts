...
• Plans to revisit and showcase some of these old, "Jacky" setups in future episodes.
...
• The narrator reveals that the LTT store will be selling tracksuits, and jokes about how they didn't do any serious business analysis before deciding to produce them.
...
• Chatbot wars are happening, including Microsoft's demo of its new ChatGPT 3.5 plus enabled version of Bing search
...
• Checking if the LTD Store has matching joggers with images showing logo and colour scheme
...
• Discussion of an AI model's capabilities and limitations
...
• Discussion of a tracksuit or water bottle colours that match with a tracksuit
...
• Colour selector issues and parsing of colour options (e.g. "sunrise", "cream scream") 
...
• Discussion of giving a multicoloured item to an AI and asking for a single coloured item
...
• Questioning why the AI keeps suggesting the workshop jacket despite it not matching the water bottle's colours
...
• Conversation about a specific game, Manheim, and its Biomass boss
• Attempting to get Cortana to provide information on how to beat the Biomass boss in Manheim
• The person is discussing a game (Manheim) and its mechanics
...
• Mention of ChatGPT's frequent errors and lack of ability to perform certain tasks, like integrating chat functionality into search results
...
• Skepticism towards ChatGPT and other sources of information
...
• Sponsorship announcement for Thrum, which makes handmade wedding bands and rings from unique materials
• Advertisements for Thrum and The Ridge
• Discussion about Squarespace and its writing tool
• Mention of ChatGPT and its potential to harvest valuable data
...
• A lighthearted discussion about how the conversation is turning into a focus on Bing with ChatGPT
...
• Idea for a new Jim Carrey movie based on his character in Liar
...
• Personal opinions and humour
• Reference to Christopher L. who applied for a job at NCI Tech Tips at the same time as Linus
• Discussion of Linus's favourite memory working with Christopher, which is unclear but possibly related to their time on NCI Tech Tips
• Mention of a "cardboard box challenge" video and other old videos from the era
• Description of the early days of NCI Tech Tips, including a small room in the headquarters and later expansion into a nearby room filled with tech
...
• Creation of box armour and helmets in a montage sequence
• Questions about why certain actions were taken, such as shouting "Expel levant!" and wielding a lightsabre
...
• Hypothesis that wear levelling or SSD longevity is the reason for varying system reserved space
...
• Mentioning an incident on XQC's stream where they discussed financial numbers and received attention from the audience
• Reflecting on the difference between streaming for 20,000 people versus a large crowd on another streamer's channel
• Discussing par asocial relationships with influencers and feeling comfortable being candid on WAN Show but not on other streams
...
• The dangers of jumping off fences and other reckless behaviour in the past
...
• Discussing specific items such as CRT monitors, Logitech Z680s, Fireworks S700s, and Kitsch ProMedia Ultra 5.1 speakers
...
• ATX power supply pin dep inning tool and Mole dep inning tool
...
• Discussion of colour schemes for a tracksuit, including a possible white and black design
• Comments on limited edition designs for special occasions
• The speaker wants a gold plushier tracksuit because they like the colour gold.
...
• Discussion of Andrew Tate's car and tracksuit stereotype
...
• Reflecting on experiences with a coworker
• Shared memories of working together, including late nights and travelling for work
...
• Mentioning the importance of the Computer trip, which marked a significant event in the company's history
...
• Discussion about travelling and visiting various places, including Japan and Taiwan
• Mention of planning and going on trips to certain destinations
• Favourite travel memories and experiences, specifically river tracing in Taiwan
...
• The role of search in shaping modern culture and behaviour
• Personal experience with a Goal device, including issues with memory loss and autosave functionality
• Criticism of the Goal's physical buttons being "just for show" and not providing necessary control
• Technical discussion of audio routing and monitoring setup for streaming
• Echo issues resolved in streaming setup
• New audio monitoring system used with Goal
