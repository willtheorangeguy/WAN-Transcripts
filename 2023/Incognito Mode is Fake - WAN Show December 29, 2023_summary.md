...
• The host talks about their translation team on Billy Bily.
• Discussion about piracy of videos and offering paid translators to upload content.
• Mention of difficulty transferring money from Billy Bily due to China's firewall.
...
• Trialing promotion with Green Man Gaming: buy desk pad and get $10 code
• Noctua screwdrivers shipping, pre-sale orders can now be fulfilled
• Update on Stubby screwdriver sales: potential for more colorways if successful
...
• Planning for the Land Center tour, including video discussion and Dan's in-person experience
• Discussion about the acoustics of the space and how to reduce echo
• Plans for a badminton center with seating for 250-300 people and a stage
...
• Comparison of Sony cameras to Panasonic/Lumix cameras
• Cost comparison between Sony and Panasonic/Lumix cameras
...
• Reference to a badminton center (later forgotten)
...
• Sponsorship announcements:
	...
	+ Thorum: handcrafted rings and watches made from unique materials
	+ Dbrand: company's partnership with the show and their products (giving out broken glass as a "gift")
• The speaker discusses their experience working with dbrand, a company that has been a sponsor of the show.
• Dbrand knows and understands the show and its audience, allowing for trust to be built between them.
• Dbrand offers new x-ray skins for various devices, which were scanned at a specialized lab, and are available in light and dark mode variants at a discounted price.
• The speaker teases that dbrand's website URL is "dbrand.com/when", with the speaker commenting on how nice it sounds.
...
• Dbrand's branding is mentioned, with one of the participants jokingly suggesting that they should rebrand as "unbranding".
...
• Team member interviews and favorite video games
...
• Comparison to hiking backpacks and the Averke Titan bag
...
• Mention of various semiconductor companies partnering with each other, specifically in regards to RISC-V creation
• Discussion about a company called Quintaris and their mission statement related to providing a single source for enabling RISC-V devices and promoting industry standards
...
• Behavior and expectations for family members
...
• Discussion of 3D movie theater setup
...
• Mentioning a possible location for it at the Land Center
• Considering rolling out a wheel base thing or having a mount that sits on the wall
...
• Branding or labeling on the cover
• Color matching with surrounding environment
• Color contrast for shuttle display
...
• Criticism vs toxic behavior in online communities
...
• Use of Seagate IronWolf and NAS drives in data servers due to availability, price, and brand preference
...
• Discussion of mesh WiFi technology
...
• Exclusives driving Floatplane's popularity
...
• Confusion about Matthew Essek's country of origin and flag representation
