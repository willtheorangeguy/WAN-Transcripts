...
• Issues with Team chat, including confusion and frustration over a scent file
• Relaying of a story about delayed Teams notifications
• Micro Centre issues with returning hardware
...
• Discussion about VGA's kick-proof design of the power supply
...
• The logistics team's handling of inventory is criticized, specifically their decision to stop labelling memory sticks with corresponding kit numbers
...
• Discussion of fashion choices, including wearing shorts to work and colour-coding children's socks
• Mention of a bulk purchase of high-quality socks for the family
• Discussing Yvonne's sock preferences, including a suggestion to have a variety of colours.
...
• Personal anecdotes about Time watch usage and Tithings smartwatch experiences
...
• Smart home technology issues with Eco bee and HomeKit
• Development expectations for certain technologies
• Disney/Lucasfilm's functioning lightsabre toy
• Discussion on the size and complexity of a lightsabre
• Comparison to other expensive Star Wars merchandise
• Analysis of why it took so long for the lightsabre to be developed
...
• Discussion on pricing strategy for the lightsabre and potential sales numbers
...
• The team discusses adding different colours or features to the whale checkmark, including an RGB option that could strobe for a higher price.
...
• Mention of Google Glass and "glass holes"
...
• Discussion of Back blaze cloud solution and data backup
• Mention of World Backup Day on March 31st
• Introduction to Zoho One platform for business management
• Reference to Yannick, a production server, with multiple copies existing in different locations
...
• A new product from LTT store is announced: the shape sorter toy, designed for tech enthusiasts.
...
• The new model is currently only available to paid subscribers of ChatGPT plus, unless used through a service that offers access to GPT-4, such as Bing.
• There are concerns about power-seeking tendencies in language models like GPT-4.
• Some users are reselling or "hustle-Opting" by using the model to create businesses without doing any actual work.
• ChatGPT's functionality and capabilities
• Reselling and rebundling of ChatGPT functions by others
...
• Comparison of GPT-4 with co-pilot functionality in Excel
...
• Microsoft's Co-pilot is an AI thought process that builds on raw GPT
...
• The Codex API is used in Coding Co-pilot, which differs from how GBT is used
• Microsoft's CEO Satya Nadella explains the concept of Co-pilot in his talks
...
• The deep green project uses data centres to heat pool water, reducing electricity costs.
...
• Similar data centres are being used elsewhere to heat buildings and water.
...
• Google announcing the Palm API and Med Palm 2, a new medical large language model for healthcare professionals
• Discussion of Med Palm 2's capabilities and its scoring on US medical licensing style questions
...
• Previous fines and penalties for mishandling patient data:
	...
	+ Goodra fined 1.5 million and ordered to stop sharing patient data with advertisers
...
• Billions of dollars spent on manipulating people's behaviour through advertising and apps
...
• Discussion about receiving many ads for depression studies and ketamine therapy
...
• Higher signalling speeds require more efficient PCB design and potentially shorter traces or retimers.
...
• The speaker has had minimal correspondence with Iraq and has limited involvement as an activist investor.
...
• Defence of budget-friendly internet options and the importance of prioritizing spending
• Unserious suggestions about merchandise purchases and cancelling internet connections
...
• Consideration for a more favourable work environment for AJ
...
• Merchandise gift card with company logo on items from a catalogue
...
• Brief mention of uploading Gods to Billy.com
...
• Linus' favourite equipment purchase for LMG/LTT Labs: a solid state server with 48 NVMe drives, which he handpicked and was surprisingly affordable
...
• Borrowing and the main quest of the game
