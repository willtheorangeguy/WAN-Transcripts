...
• Discussion of The Ridge, Squarespace, and JumpCloud sponsorships
...
• Mention of foveated rendering, pupil tracking, and eye-tracking technology
• Demonstration of foveated rendering using a game, with a spotter trying to guess where the player was looking based on render quality
• Impression that foveated rendering is working as intended in the PSVR2, despite initial concerns
...
• The creator of the IVRE driver thinks it's not worth trying to use the original PSVR on a PC
...
• Discussion of Floatplane's value proposition and potential for additional tiers
...
• Description of current exclusive content offerings on Floatplane
• Flowplane exclusive feature is coming
• Merch messages are being looked into for improvement, including integration with ShopPay
...
• Discussion of the game Fantasian and its development by a team including Hironobu Sakaguchi and Nobumutsu
...
• The mobile subscription model affects gameplay, particularly for multi-part releases where leveling curves change unexpectedly.
• Certain enemy mechanics are considered lazy or unfair design choices, such as one-hit kills and unblockable attacks.
• The speaker is discussing a game with poor balancing and unfun mechanics.
...
• The speaker is frustrated with a game, likely Fantasian or another similar game, due to its repetitive and unenjoyable gameplay.
• They compare the game unfavorably to FTL, praising FTL's satisfying final boss fight design.
• The speaker suggests that FTL-like games could benefit from more dynamic boss fights that change over time.
...
• The speaker shares a story about someone quitting a game (Tarkov) due to difficulty with a specific aspect.
• The speaker quit playing Escape from Tarkov due to frustration
...
• The speaker compares Tarkov to EVE online, noting that it competes with it in terms of complexity
• The game offers a unique blend of action and shooter gameplay
• Other games have tried to emulate Escape from Tarkov but failed to capture its essence
• The game wipes occur frequently, resetting character progress and forcing players onto a level playing field.
• Players must cope with unstable gameplay mechanics, including janky guns with horrible recoil.
...
• Goat Moth, a Tarkov creator, has a video about cheating that was not public yet
...
• Difficulty identifying cheaters due to server issues and desync
• Request for replay system to watch matches after they are complete
• ESP (wall hack) type of cheating prevalent in Tarkov
• Ability to see through walls, names, KD, inventory, and other player information
• Lack of detectable measures by BSG (Battlestate Games)
• The person being discussed went undercover to investigate cheating in a game
• He tested people by following them around and observing their behavior
...
• Cheater's behavior of following players who haven't cheated and eventually revealing their cheating
...
• The speaker was playing Tarkov and was impressed by an opponent's legitimate gameplay
• The opponent had not been cheating or using aimbots
...
• Presence of cheaters in multiplayer games, including Warzone and League of Legends
...
• Valve banned 40,000 players from Dota
...
• Valorant's anti-cheat software is overly invasive, causing conflicts with other cheats in games like Tarkov
...
• Considering Todd Howard as a guest for the Wanshow, with the host expressing interest in talking to him about games and products he has made
• Mention of previous controversies surrounding Todd Howard's team at Bethesda Softworks, such as horse armor
...
• JumpCloud: open directory platform for IT management
...
• Discussion of Best Buy's colors, with multiple people arguing over whether their primary color is blue or yellow
...
• Personal experience of encountering both positive and negative interactions while traveling, including a difficult experience in Paris
...
• Statue of limitations for past events
...
• Anonymous asked about thoughts on Jeff Geerling's review of the screwdriver, with one person responding critically about thumbnail and title accuracy.
• Another anonymous asked about favorite LTX 19 moment.
...
• Explanation of the Silicon shortage during the Corona virus pandemic's impact on the auto industry
...
• Flowplane's hiring plans (anticipating Q3 or Q4 hires)
...
• Garen asked if there was a brand standard manual for advertising graphics and received unclear responses
...
• Mention of the Lamborghini (Lambo) as a notable moment in the universe
• The sad Linus or Linus selfie-like memes being mentioned as another notable moment
• Reference to the original screwdriver being orange and setting the color tone for the company forever
...
• Discovery of the original tracklist and rewritten lyrics with a tech theme
• A user sings a terrible rendition of "Tis the season" with humorous commentary
...
• Buying the S95B TV is not worth it if someone can't afford a Bravia
• Waiting for QD OLEDs to get cheaper is a more practical solution
• The answer to affordability issues is often waiting for new technology or buying second-hand
• Linus shares the story behind his katana and its connection to his girlfriend's love
...
• Mr. Trattle's innovative teaching methods and passion for computers
...
• Linus Tech Tips merchandise, including the "swacket" and underwear
...
• Linus's watch and Withings brand smartwatch features
...
• Anonymous's question about favorite flowers and Zelman CPU cooler
• Eric's question about Linus's time with the GPD Win 4 after a short circuit
• The speaker is discussing their current use of a device called Ionio
...
• Upgrader's frequency and budget considerations
...
• Personal anecdotes about past experiences with video conferencing and infrastructure
...
• They reminisce about the texture and flavor of older versions of Smarties (which are referred to as "rocks" in Canada).
...
• Discussion of a sponsor, YouGreen
