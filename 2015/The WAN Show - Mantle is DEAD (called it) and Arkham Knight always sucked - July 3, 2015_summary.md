...
• The host discusses why Mantle never gained traction and was overshadowed by DirectX 12 and Vulkan
• Teespring is resending shirts that were printed with incorrect colors
...
• There are currently 63% of voters in favor of purchasing the new shirt
• Firepole idea and voting on whether Linus should install one
• Discussion of the impracticality and liability concerns of having a firepole in an office environment
• Proposal to use a camera to film people using the firepole, making it a fun prop
• Alternative suggestion: enrolling Luke in pole dancing classes for core strength
• Discussion of core strength exercises
• Pole dancing lessons for Luke Berkel
...
• Rumors about the specifications of the GTX 950 and 950 Ti
...
• The reviewer watched the movie "Avengers: Age of Ultron" and enjoyed it, comparing it favorably to "Fury".
• The reviewer also mentioned enjoying the movie "Kingsman", describing it as ridiculous.
...
• A user mentions that networking, specifically SMB 3.0 multi-channel, is not working as expected.
...
• The conversation touches on the Starcraft 2 campaign and a frustrating ending, leading to a revisit of the Warcraft 3 campaign
...
• Personal conversation unrelated to the initial topic, including a discussion about hair color and gel usage
...
• Community members found two pump revisions: one with a shiny Cooler Master logo (new) and one with a colorful logo (old)
...
• Alternative platforms (DailyMotion, Twitch, Azubu)
• Algorithm for discoverability of new content vs user experience
• GOM TV and other video platforms (Vimeo, Vessel)
...
• Humorously discussing underwear (panties vs commando)
• Mention of visiting the EMP Museum in Seattle to see Princess Bride and Star Wars props
• Upcoming event: Vlogger Fair
• Apple iPhone 6S rumors: pressure-sensitive display, no dual-element camera
...
• Comparison of the behavior of users who reach critical mass vs those who don't
