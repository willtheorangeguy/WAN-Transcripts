...
• Tech news topics are discussed, including:
  • Z170 chipset launch with Skylike enthusiast-grade processors
...
• Skylike motherboards support both DDR3 and DDR4
• Skylike CPU frequencies and boost capabilities discussed (4 GHz nominal, 4.2 GHz turbo)
• Efficiency of Skylike CPUs mentioned (91w TDP, extremely efficient)
...
• Intel's Skylike CPUs will have compatible mounting sockets with previous generations
...
• Intel is keeping details about architectural changes from Bradwell to Skylike private until August 18th
• NVIDIA has previously disabled overclocking on their Maxwell GPUs, but promised unlocked overclockable Skylike mobile CPUs
• Intel has also committed to full range of base clock overclocking and improved memory overclocking on their 2015 Skylike processor
...
• The Cherry MX silent switch comes in red and black linear variants, but not cliquey switch variants
...
• Discussion on why the speaker uses these units due to cultural and physical influences from neighbouring countries (Canada's use of both systems, American influence in Canada)
...
• Comparison to other monitor prices on New egg
...
• They mention Richard Buddy's statement that there may not be an OEM interested in building the product.
...
• Discussion of Samsung Galaxy Note 5 rumours and features
...
• The user expresses frustration with Windows 10s design choices, such as requiring users to tie their email accounts to the computer and making it difficult to customize settings.
...
• The user shares news articles about Windows 10 telemetry, including an Ars Technica article that discusses how Windows 10 gathers data on users' behaviour and sends it to Microsoft.
...
• Article from Tech Radar about running Windows 10 on low-end hardware
