...
• Google's refusal to fix WebView vulnerability on Android versions prior to KitKat
...
• Introducing the Synco phone, a single-button phone that can only make calls
...
• Storage.IO (STORJ) is a peer-to-peer network for cloud-based storage
...
• A discussion about torrenting and mesh-based networks is introduced, but quickly diverted from
...
• Discussion of MacBook Air rumors
...
• Comparison to Asus ZenBook UX305
...
• R9 380X and R9 390X are rumored to include HBM.
...
• FreeSync monitors arriving in office for testing
• Comparison of AMD's FreeSync with NVIDIA's GeForce Experience and 3D technology
• Advantages of AMD's FreeSync, particularly in multi-monitor setups
• Certification process and lack thereof for FreeSync
• Fee structure for FreeSync certification, potentially charged by third-party companies
...
• Discussion of a shopping center in the Lower Mainland
• Mention of specific store names (Woodward's, Eaton's, Woolco, Marks and Spencer)
