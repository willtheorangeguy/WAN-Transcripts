• Luke is not present due to his attendance at Computer
• The show's timing issues are attributed to Luke's presence/absence
• Upcoming AMD and NVIDIA announcements from Computer
...
• NVIDIA is good at keeping secrets and rumours are often true
...
• Monitor features: RGB colour gamut, 138 PPI, 10-bit display with 16-bit lookup table
...
• Comparison of G-Sync and AMD's Free Sync technologies
• NVIDIA's future plans for G-Sync module on the desktop side
• Discussion of hosting the show without Luke
• Review and discussion of Radeon R9 rumours and potential rebadges
• Mention of AMD's Tonga GPU and its 384-bit memory controller
• Rumours about Fiji GPU, including a possible Fury card and Halo-type design
...
• Review of Intel's Bradwell processor for desktops and its performance in gaming
...
• Die shots of Bradwell CPU, showing that only half the die is used for the CPU
...
• Outsourcing is still prevalent, as seen in the Disney case where employees were laid off and required to train their replacements
...
• Intel's 65-core smartphone, which is actually a modified Oenone with a 61-core Leon taped to its back
...
• Fractal Design is mentioned as an example of a company that built their success on improving upon existing products (the Aztec P180).
...
• The speaker had trouble posting Computer news in their dock, had many notes, and had to cut down on content
...
• Teaser for Computer coverage and reminder to stay subscribed
