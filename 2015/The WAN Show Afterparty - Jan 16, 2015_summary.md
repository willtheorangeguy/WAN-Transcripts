...
• Review units from Obutu, SciTech (X55 Hotas), and possibly Thrustmaster (A10) are being considered.
...
• Design process for the arrow and background color changes (red to gold to blue)
...
• Art project with blue eraser, water, and brown colors
...
• Introduction of "Anuksuk" character and debate over its meaning and appearance
...
• Decision to paint the background a blue color as homage to the original background
...
• Discussion about a digital art project with the mention of background colors and maple leaves
