• Intel has unveiled Broadwell E, their new flagship desktop processors
• Pricing for HEDT (high-end desktop enthusiast) parts starts at $434 and goes up to around $369
...
• Gaming performance is similar across different Extreme Edition processors, and the 10-core model may lose to a Skylake quad core in some cases due to its lower clock speed.
...
• The Xeon E5 V4 lineup offers comparably priced processors with more cores and better performance, such as a $1,745 chip with 14 cores clocked at 2.4 GHz and a max turbo speed of 3.3 GHz.
...
• Competitiveness with Intel Xeon processors in multithreaded workloads
• Adobe Premiere workflow and performance on quad-core processors
• Evaluating the need for additional cores in a heavily multi-threaded workload
...
• They speculate that Intel was worried about cannibalizing sales from their Xeon line if the new processor was too powerful.
...
• Speculation and rumors about the release timing of the Zen architecture
...
• There is ongoing debate about the impact of violent video games on children's behavior
...
• High-performance SSD specifications (512 GB capacity, 15 x 48-layer VNAND flash chips)
...
• Discussion about Asus' Zenbo robot
...
• Skepticism about Zenbo's usefulness and value compared to smartphone features
• Mention of a lengthy 11-minute YouTube video showcasing Zenbo's features
• The speaker is expressing frustration with the Zenbo robot and its limited functionality
...
• The Zenbo's ability to move around independently is also seen as a negative feature
• The speaker compares the Zenbo unfavorably to other robotic assistants and suggests that it is not yet ready for release
...
• Prices of other manufacturers such as Zotac, Gigabyte, and Asus are also high, with some being 57% to 87% more expensive than Nvidia's prices.
...
• Mention of a review of cat headphones from Brookstone
