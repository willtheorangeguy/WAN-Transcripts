...
• Online platform Zeroth is shut down, affecting users who care about it
• Microsoft sues the US government over gag orders and data requests
• The Helicopter, a certified manned multi-copter, is mentioned
...
• Review and critique of the HTC 10 phone by nanotech and its features
...
• Discussion of an esport equivalent to the Olympics
...
• Mention of a private World of Warcraft server called Nostradamus and its shutdown due to copyright infringement
...
• Discussion of the shutdown of Nostrils, a private WoW server
...
• The source code issue is brought up as an excuse by the developer, but the speaker disputes its validity, citing the availability of exact data from databases like Bowhead.
• The streamer addresses issues with Twitch's server and acknowledges that it's not their fault.
• Sponsorship segments are announced for Mantra and Squarespace, promoting their products and services.
...
• Helicopter (Helicopter) multi-copter aircraft discussed
• Certification and production of Helicopter
...
• Rumours about Nintendo's NO console mentioned it would have an x86 architecture and backup data to Nintendo servers.
...
• The NO is expected to support additional screens, potentially leading to new TV wall mount designs.
...
• Discussion about console emulators, specifically Bleed!, a commercial PlayStation emulator
• Mention of purchasing old games, including Fable 1 and Need for Speed: Most Wanted, for Xbox and other consoles
• Brief mention of Nintendo NO rumours, including potential Wii U ports and remasters
...
• Adapting Oculus Rift exclusives to work with HTC Five through Libber/Review program
• Leaked pictures of NVIDIA's Pascal-based GP 104 and 106 GPUs
• Criticism of NVIDIA's use of code names for their hardware
• Nvidia leak rumours, including specs for the GTX 1080
...
• First 10-core smartphone announced by Menu
