...
• NVIDIA's Pascal gaming GPUs rumoured to be announced today at 6pm
...
• Quantum computing is particularly useful for complex modelling, such as weather systems
...
• Rant about the limitations and frustrations with certain features in Windows 10s Photos app
...
• Confusing behaviour of the "up directory" function
...
• Next Gen AI "Via" (or possibly "Vi") to be debuted at an industry conference, described as a global brain that simplifies interactions with services
...
• Showcase of the shirts and discussion of their design and availability on Tee spring
• Complimenting a user's shoulders during a live chat session
• Review of a product called "fly board air" that allows for hover-like flight
...
• Buttonless fingerprint sensors coming to phone this year
