...
• Mushkin announced a $500, four terabyte SSD that the host tried to buy but wasn't available
• Engagement metrics are discussed, showing high viewer participation and enthusiasm
• The host's company secrets (specifically Squarespace and TunnelBear logos) were mentioned, with a joke about not being able to display them
...
• Reference to the Fallout rig and its development with LimeTech
...
• The Vive was reported to be $1,500, but this claim came from a Taiwanese website and may not be accurate.
• The original article was likely an unsubstantiated rumor or speculation.
• The speaker has switched to being on the "Vive bandwagon" after seeing its improvements at CES, particularly with regards to tracking and screen quality.
• The Vive now has a camera on the front for features such as eye-tracking and potentially cat detection (also known as the "cat detection system").
...
• Rumors about Apple introducing audio output profiles to compensate for the loss of the headphone jack
...
• TunnelBear VPN: easy-to-use app for mobile and desktop, free first 500MB of data per month, unlimited data for a few bucks/month
...
• Overclocking on non-Z chipsets: Skylake CPUs and H-class chipsets, limitations and trade-offs (hyperthreading, voltage/power consumption, crashing problems)
• Custom modifications and firmware required for certain motherboard makers (Supermicro, ASRock) to work with non-Z chipsets
...
• The company is recalling the units due to a 10% leak rate in a different way than Linus Media Group's leak
...
• Price drop of AMD R9 Nano graphics card from $6.49 to $4.99
• Review of the R9 Nano card being referenced in a previous conversation
• Mention of upcoming SSDs, specifically Mushkin's preview of a $500 4TB SSD at CES
• Mushkin's new 4TB drive combines two controllers and 2TB drives in a JBOD configuration
...
• Intel confirms an erratum in Skylake processors causing crashes
