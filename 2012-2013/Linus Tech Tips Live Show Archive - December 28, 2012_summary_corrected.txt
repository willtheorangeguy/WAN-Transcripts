...
• Forum update: using bulletin Connect 5, still figuring out hosting and launch details
...
• Brief discussion of computer hardware, including power supplies (OCC AT) and graphics cards (AMD 7870 XT)
• The host is defending his use of the TJ07 case, despite criticism from others.
• He compares the prices of boutique builders like Falcon and custom cases with similar components to those offered by NCI or Main Gear.
...
• Discussing the Racer Kraken Pro headset and an Alienware laptop purchase
• Examining the OCT Vector and Samsung 840 Pro SST storage devices
• Reviewing the Sandra cooler, its design, and potential issues with noise and performance
...
• The Cooler Master Quick fire TK keyboard is discussed, including its unique features and suitability for space-constrained users
...
• OS X vs PC: the user prefers PC to OS X due to limited gaming options on Mac
...
• Power supply recommendations, particularly for modular and easy-to-sleeve options from VGA and Silverstone.
• System build discussions, including SSD recommendations.
• Comparison of Samsung 840 Pro drives
• Mechanical keyboard features and switches (Terra mix blue)
...
• Budget video editing rig recommendations (3770K, 16-32GB RAM, MATE board)
...
• Mention of games played, including Left 4 Dead, Far Cry, Crisis, and Final Fantasy 6
...
• Rosewall power supply
• Tech fair in 2013
• Poet's tweets not being shown on live stream
...
• Samsung acquired Novel, the company behind Datable caching software
• Datable caching is a solution that dynamically loads frequently used data into an SSD off of a hard drive
• The acquisition could be interesting for the SSD caching market
• Samsung's ownership of Datable may change the competitive landscape
