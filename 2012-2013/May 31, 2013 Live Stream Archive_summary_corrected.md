...
• Upcoming Computer event, with changes to the company's approach this year
• Larger team attending Computer, including Slick, Diesel, and B-Roll
• Focus on covering the show, with some travel blogging and potential humour
• Discussion about B-Roll and its potential behaviour
...
• Computer show coverage and previous CES coverage by Slick
• Discussion about digital signage and rotated displays
• Plans to split into two teams for show coverage
• Upcoming coverage of Computer with a team effort between A and B teams
...
• Plans to produce NCI Tech Tips videos for the NCIX.com channel
...
• Mention of a build by Crab Creations with colour issues on Google Drive
...
• Discussion of UFC fighters, with one person mentioning George St. Pierre as their favourite.
• Richland Apus: slightly better than old ones but not by much, still under embargo.
• Budget builds on NCI: unclear what the question is asking.
• Configuring pre-dumpers: no longer done.
• Panel discussion between TFT (just another LCD), IPS (a type of LCD with good colour reproduction), and TN (better for gaming).
...
• Sound cards: buying recommendations (Asus Sonar) and general advice for selecting one within budget
...
• Key switches: thoughts on the Alps key switches, comparison to Cherry MX greens, and Cooler Master's potential availability
• New HQ: naming suggestions for Linus Media Group's new headquarters
• Forum discussions: favourite thread (meme thread), and request to take off Slick's shirt
...
• Survey results showing PC as the preferred device to tablet for Americans
...
• The importance of adapting to changing consumer behaviour in the gaming industry
...
• Gaming news and rumours, including confirmation of GTA V on PC
...
• Favourite energy drink is Talon
...
• Questions about upcoming AMD APO's and their potential for videos
• Budgeting for a summer PC build ($1,300-$1,400)
• Query about the release of an NVIDIA 760 GPU and its cost
• Recommendation against using Hybrid Phys 7 due to it being underpowered
• Recommendation of the Asus MATE motherboard for a build
...
• Western Digital is sponsoring prizes for a trip to Computer
• Corsair and NCI are also sponsors of the prizes
• The host is leaving to go to Computer on a jet plane
