• Bios hock Infinite audio quality difference between PC and console
• New Android technology providing info while pausing video or music
• OUA appears to be a fiasco
• Blackberry alerts might be telling friends it's "happy time"
• In-game footage vs. pre-rendered cinematic
• Scamming on v bulletin 5 and its connection to game cinematic
• Facebook phone images surface, rumour of HTC as OEM for Disney
• LucasArts shutdown
...
• Bios hock Infinite video discussion
...
• OUA, an Android-based gaming device that was supposed to be a competitor to bigger consoles
• Kickstarter campaign for OUA
• Features promised by OUA, including improved responsiveness and simplified game installs
• The speaker discusses the potential failure of a game console project, OUA
...
• Competition with Terra 4 launch and potential performance comparisons
• HDMI and wireless standards lowering latency
• Emulators and their limitations in gameplay quality
• Terra 3 and its handling of latency and emulation
...
• OUA's potential success is questioned due to planned obsolescence and the rise of Android devices with Terra 4 technology
• Emulation might be a key factor for OUA's survival, but it may not be enough to compete with PC gaming options
...
• The potential for consoles like OUA to make money through accessory sales is mentioned
...
• Comparison between a smart TV and a Terra processor-based device
• Analysis of why companies like Samsung might not use a Terra processor in their smart TVs
• Prediction that a premium-priced Android TV from Samsung would be out of reach for most people
• Criticism of OUA's specs and uniqueness
• Comparison to Wii and its ability to bring people together through gaming
• Proposal for OUA to be a smart TV in a box with apps like Plex
• Discussion of Android's potential to make OUA an affordable home theatre PC alternative
...
• The importance of capturing and analyzing video with coloured overlays
...
• Aztec's article on AMD's perspective on the issue and commitment to fixing it
...
• Discussion of sync and frame rate limiting
...
• Announcing plan to migrate off bulletin 5 due to issues with software
...
• The software (Bulletin 5) has critical functionality issues, specifically with navigating between pages in a forum thread.
...
• Discussion will move on to why pre-rendered cinematic in games don't matter
• The speaker discusses being deceived by pre-rendered cinematic in a video game
• The speaker compares this to Bios hock 2 and how they were misled into thinking it was a great game because of its trailer
...
• Autoplay button vs. turn-based combat in FFA
• Interruption to discuss V-Bullets and mods
• Oyster pizza discussion and Pan ago comments
• Winspeed36 helping with forum hosting
• Upcoming new software and rack space for NCI warehouse
• Discussion of power supply and backup systems
• Reference to Captain Planet and "heart power"
• Teasing about someone being a "barony" (a fan of My Little Pony)
...
• Available in red, silver, and light blue colours
...
• Review of a Wind force cooled Titan graphics card, including its design and performance
• Comparison between the stock cooler and Wind force cooler on the Titan
• Mention of overclocking capabilities of the Wind force cooled Titan
• Brief mention of Hybrid Memory Cube as a news item, but no in-depth discussion
• NCI project and its limited work schedule
• Bidirectional bandwidth increase in DDR3 technology
• Pre-soldered components on the board, potential for modularity issues
• Analogous to Ani morphs' "cubes" technology for data storage
...
• A thread will be created and stickier on the Build Logs section
...
• Some builders get featured in the Build Logs of the Week, which is a prestigious honour
...
• CPU architectures and the possibility of 10 nanometre or fewer CPUs
...
• Mention of a "benching cave" where work is done and could be featured in the video
• Plan to feature the benching cave as a background in the video
• Reference to a user on their forum, the "Norwegian guy", who is developing mods for Skyrim and Borrowing
• A fodder is working on a project called Sky wind, which adds Skyrim content to Borrowing.
• The fodder lost all their data due to a server crash and had to recover it from backup.
• The team is developing their own original soundtrack for the mod.
• The host still works with NCI but is no longer in management.
...
• Linus's hairstyling routine before Tech Quickie episodes
