...
• Discussion of Racer Comes for live calling and its benefits
• Explanation of how to use Racer Comes for the livestream
• Slick's experience with using Racer Comes in his gaming group
• Unique system for allowing people to call in on comes during the show
...
• Cloud saves and their implications (e.g., permanent)
...
• Confusion over whether Zach is connected or not, and attempts to resolve technical issues with voice chat and comes
...
• Question from Zach about whether the host has Rome and rooted his HTC One
...
• Introducing a guest, Lime fire, and discussing Jeopardy song singing
• Technical issues with Lime fire's connection
• Discussion of downloading comes software for easier communication
...
• Discussion of Google Glass security concerns and Blue box's proposed use cases for exploiting vulnerabilities
...
• Call (spreadsheet software) can handle large amounts of data efficiently.
...
• An old YouTube video from NCI Tech Tips (2008) was referenced for guidance on overclocking.
• NCI Tech Tips YouTube channel
...
• Mention of specific effective ad examples (Smart's Ship My Pants, plus-size lingerie)
• Comment on the inefficiency of advertising and spending money on unwatched ads
• Colour sorting discussion and joking about not having to do grunt work
...
• Tech Net account usage for IT managers and testing environments
• Microsoft software access and licensing costs
• Microsoft is discontinuing Tech Net, a platform that provides free access to their SDKs and libraries.
• Users have until August 31st to get a Tech Net account before it's removed.
...
• Microsoft has made unpopular decisions in the past, but the Tech Net community may not be large enough to influence a change.
...
• Defence of the fan by Mr. Linus, citing safety concerns
...
• A proposed system for Sky Train (or Skynet) to push advertisements to passengers who lean against windows while sleeping
...
• The caller is discussing Enacted's benchmarks for 4K gaming and how they used super sampling antialiasing (SSA) to test performance.
• SSA simulates a higher resolution by upscaling then down scaling, which can be similar to benchmarking at a higher resolution like 8K.
• However, the host notes that this is not exactly equivalent due to the system load and the way super sampling works.
• The conversation shifts to discussing Racer Comes as an alternative to other voice communication services like Skype or Mumble.
• The host praises Racer Comes for its ease of use and gamer-like features, and notes that it has gained hundreds of thousands of users.
• VTOL rolls out near gigabit fibre in Vermont for half the price of Google Fibre.
• The company received an $81 million stimulus package from the government to set up their service.
• The service costs $35 a month, which is significantly cheaper than Google Fibre's prices ($70 for speeds similar to VTOL).
• A new Vancouver-based internet provider will offer fibre 60 times faster than the Canadian average for $45-$65 a month.
...
• Discussion of NEW gaming PC by Wolf Rage
• Discussion of an impressive NEW gaming PC build
...
• sync can introduce additional input lag in gaming
• Some gamers may prefer to disable sync or use adaptive sync for competitive games
