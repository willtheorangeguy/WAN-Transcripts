...
• Discussion about Blackmagic Intensity Pro cards
• Introduction of a new system for unboxings (dual cam setup)
...
• Inputting both video files in Premiere for easier switching and color correction
• Camera settings and color tuning
...
• A viewer, TechX, shares their issues with Windows and Rapid Storage Technology (RST)
...
• The speaker is confused about why Slick is excited for a PS3
...
• Internet connection latency can cause games to be dumbed down
...
• Mention of public companies with low margins in the RAM market (Hynex, Kimondo)
...
• Analysis of the Bioshock Infinite game, with opinions on its quality and comparison to other games in the series
• Comparison of the Crysis and Far Cry game series, with opinions on the quality and gameplay of each
• Discussion of playing Far Cry 3 and its performance on a GTX 590 graphics card
• Defense of the GTX 590's capabilities compared to newer generation cards
...
• Discussion of Crysis 3 system requirements and potential performance issues
...
• Discussion about headphones and audio equipment used by the speakers (SteelSeries 7H, Dual 570s, or Single 600 series)
...
• Random unrelated topics (Gautacon, winning a prize)
...
• They took home prizes, including a BitPhoenix XL console
...
• The host reaffirms their relationship with NCIX and its tech tips series, stating they will continue to work on it.
• Discussion about unknown entities that can see or hear
• NCIX Tech Tips' future projects, including the BitPhoenix water cooling guide and new content
• Change in roles, with the speaker no longer being a product manager
• Explanation of the studio's continued work on NCIX Tech Tips despite changes
• Mention of personal circumstances affecting plans (new baby)
• Reference to past experiences and frustration with multiple job roles
...
• A Blackmagic camera ad is mentioned as an example of sponsored content.
...
• Clarification of NCIXcom's status and future plans
...
• Discussion about the Avermedia card and its relation to choppy video
• Mention of Tech Syndicate's Logan and his YouTube channel
• Conversation about Nvidia Titan, including rumors and speculation
...
• Rumors suggest it will replace the GTX 690 as opposed to the GTX 680
...
• Avermedia software refresh issues
• Twitter updates about Windows 8 giveaway
• Techquickie YouTube channel mentioned
• Freddy's Kickstarter for Video Game High School
• Show is made by Rocket Jump, a group led by Freddy
• Features several YouTubers, including Brian Ferenzi and Epic Mealtime's host
...
• Discussion about past work at NCIX and not being well-known as a brand owner
• Monkeys as pets
• Favorite shows on Revision 3
...
• Relationship with Linksys as a trusted networking brand
...
• Introduction to upcoming SteelSeries vinyl wrap product
...
• Comparison with Netflix and movie theater releases on YouTube
...
• The speaker is opening a box from Ergotron with "juststand.org" branding, but bought it directly from the company
...
• He's been using $25 speakers from years ago and considering upgrading to the Klipsch ProMedia 2.1s after reading reviews
• Klipsch ProMedia 2.1s speakers are mentioned as a comparison
• SP2500s computer speakers were purchased due to being a good deal
• The speaker the wife is using (SphereX Xbox speakers) has a hiss at close range
