...
• Talking about online StarCraft tournament to fund charity event
...
• Unboxing and review of the Corsair H100i watercooling system
• New features in the H100i, including magnetic mounting hardware and new fans
• Comparison of the H100i to previous versions
• Recommendation for an NMO gaming mouse and keyboard, including the Corsair K90 and Razer Naga
...
• Discussion of sound cards, including Claro Halo and Zonar ST
• Preference for modern sound cards with driver support over dedicated PhysX cards
...
• Discussion of network stress testing using multiple uTorrent clients and an FTP download
• Testing of the EA4500 cloud router against the MyNet900, with a focus on automatic QoS (Quality of Service)
...
• Comparison between the EA4500 and Linksys routers, with the EA4500 performing better under heavy load
...
• Question about potential interference with H100 iMagnet
...
• Channel motherboards.org has lost over 13,000 subscribers due to Elric's departure
• Difficulty of recasting a popular channel host like Elric
...
• They dislike the need to constantly sign into the App Store on an iPhone.
...
• Nvidia's Tegra 3 chip is holding back Android tablets due to its performance issues compared to iPad processors.
...
• NVIDIA's graphics cards, particularly the 660 Ti Power Edition, have been criticized for their overvolting issues.
...
• NVIDIA's business struggles, specifically with GTX 680 sales and RMAs
...
• Secondary laptop specs, specifically regarding running Crysis 2
• Qualcom Snapdragon S4 Quad Core chip discussion, with opinion that Apple can stay ahead of the curve
• AMD sale speculation
• Razer Synapse drivers controversy
• Cloud save file systems for games and software
• Discussion of save file syncing and Razer's new setup
• Problem with Razer settings being lost when internet connection is lost
...
• LinusTechTips website revamp: installing VBulletin, adding articles and content management system
• Potential collaboration with Diesel and SlickPC for CES coverage
...
• Disappointment with the game trailer featuring a song that turned out to be "I'm Coming Home" by Diddy
• Mention of other upcoming games including Black Ops 2, Hitman Absolution, and Battlefield 3 expansion
• Problem with Punkbuster not installing on PC, preventing gameplay
• Discussion of playing non-secure servers in Battlefield 3
• The speaker's past experience playing a game on a live stream failed due to mental fatigue.
...
• Mention of Starcraft 2's delayed expansion and poor content additions
...
• Comparison of current touch screen issues to past problems such as tetrapack recycling
• Commentary on buying habits and encouraging viewers not to buy more technology than needed
• Audio levels and quality
• Elric being fired (and possible confusion with Tiny John Logan)
...
• They discuss the ranking and the possibility of someone more handsome existing, with the other person suggesting they use a shaver for Movember.
...
• Value-added peripherals, such as high-quality keyboards and mice, are often sacrificed in favor of cheaper alternatives to keep costs down.
