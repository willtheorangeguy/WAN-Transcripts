...
• iOS 7 iSwitch and decision not to switch to iPhone
...
• Upcoming video on the TechQuickie channel about decimal vs binary
...
• Update on current work arrangement with NCIX, including hosting Tech Tips videos and Computex coverage
• Addressing controversy over a Booth Babe video from Computex 2013
• Rational behind not posting the video, citing its polarizing nature and focus on tech content
• Discussion of ad playback issues and YouTube video quality
• Recap of Computex coverage with B-Roll's footage of the show floor
• Mention of various booth attractions, including QNAP girls and a Superman-themed PC build
• Reference to difficulties in finding attractive models for demonstrations at Computex (specifically mentioning a blonde model from Russia)
...
• Next-gen consoles' x86 processors and multi-core capabilities could lead to more efficient PC gaming
• Consoles' similar architecture to PCs may enable OpenCL or multi-core optimizations for games
...
• TechFanatic mentions their name and a PC update
...
• The speaker draws an analogy between paying extra in a movie theater to cover costs and paying more to watch content at home
...
• The topic of Microsoft and Kinect's potential implementation of home monitoring is mentioned, with the speaker expressing skepticism.
...
• Comments on the validity of the issue and past experiences with driver updates causing fan issues
...
• Mentioning a visit from Red Deer and unboxing upcoming products (Zonar Phoebus and Rampage 4 Gene)
...
• Apple's Mac Pros do not have easy upgradability of storage
...
• The current design is seen as a cost-effective but limited approach to upgradability
• The speaker discusses the build quality of non-Apple PCs, specifically mentioning Acer and Asus ZenBook Infinity
...
• A mention of Computex and meeting with WD representatives.
...
• Piledriver architecture, no new process node or architecture
...
• Rumors of a 200W TDP chip and its implications for system cooling requirements
• AMD's achievement of surpassing 5 GHz CPU frequency and its significance
• Shift in focus from high frequencies to multi-core processing
...
• Mention of Andre Yang binned his own CPUs for the OC Main Event at Computex
• Discussion about overclocking and chip quality, specifically mentioning the optron 165 and e6600
...
• Technical difficulties with audio and video streaming, including dropped connections and desynced audio
• Discussion about upcoming system build showcases, including Andre's personal Z 77 rig
• Active noise cancellation heat sink demo at Computex
• Benefits of improved airflow and controlled environment for active noise cancellation
• MSI Twin Froser 3 graphics card and clean cable management in a build log
