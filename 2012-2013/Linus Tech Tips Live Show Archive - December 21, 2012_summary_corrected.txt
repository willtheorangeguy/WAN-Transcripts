...
• Recommendation to monitor temps, Prime 95, and Me test system stability
...
• Swift Key keyboard app and its features
...
• Mention of Terra 4's performance and potential competitors (Crate/TI/Apple)
• Analysis of NVIDIA's current market position and future product releases (Ultrabook, Optimum)
...
• Recommendation of specific coolers (Noctua D14) and graphics cards (ANY Squadron 6000)
...
• The speaker has a background in social media, having used various platforms including the Palace, MSN Messenger, Exotic, and MySpace (but not as an active user).
...
• OCT vector SSD benchmarking and initial findings
...
• OCT still needs to work on its financial stability despite positive developments
• Reputation of OCT power supplies
• Low RMA rate for OCT at NCI (2%)
• Comparison to other brands (Aztec, Sea sonic, Corsair)
• Misconceptions about OCT quality and reliability
...
• OCT beta application for SSD caching on Linux
...
• OCT offering competitively priced SSDs with a Linux caching system for automatic data caching
...
• LSI acquisition of Sand force and implications for SSD caching
...
• Automating donations through recurring payments or Diva loans
...
• Favourite apps and mechanical keyboards mentioned in previous episodes
• Mentioned favourite mechanical keyboard (Kabul 60)
• Host's personal preference for storage solutions (Back blaze storage pod)
• Apology for almost forgetting to discuss something
• Review of comments from viewers on the "money likes" topic
• Receipt of a gift from a viewer, a Twinkle, with a note about it being the first time the host has received mail from a viewer
• Unboxing and review of the Twinkle
• The host tries a Twinkle for the first time due to viewer mail and discusses its taste
• The Twinkle is compared unfavourably to real food, with the host saying it tastes like "fat"
• A box of Twinkles is put on the wall of legend after the host tries one and decides to keep trying them
...
• Debunking the "Twinkle" myth and discussing its relation to Hostess.com
• Upcoming gaming bundle
• Using bulletin software for moderation and selecting moderators
...
• IT vs MATE vs ATX motherboard sizes and expansion options
