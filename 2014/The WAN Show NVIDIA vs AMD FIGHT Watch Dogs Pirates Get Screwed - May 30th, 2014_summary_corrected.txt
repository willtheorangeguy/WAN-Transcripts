...
• Discussion of Nvidia's Game works, including its purpose and how it affects performance on AMD products
• Criticism from AMD about Game works' proprietary nature and impact on gamer choice and performance
• Nvidia's approach to game development with Game works, including their collaboration with game devs
...
• Game works' benefits and drawbacks, including performance differences between NVIDIA and AMD hardware
• The pros and cons of using Game works from a developer's perspective
...
• Comments on the difficulty of benchmarking games due to login issues with play
• Straw poll results showing most voters want indie devs to be able to take advantage of Game Works and run their games on AMD hardware
• Discussion about the pros and cons of Game Works, including its potential benefits for game performance but also drawbacks such as uneven physics implementation across different hardware platforms
...
• Windows 8.1 is blocking TrueCrypt with its Smart Screen feature, detecting it as malware.
...
• Developer defence of 30 frames per second (fps) resolution in games
...
• Console developers should prioritize better graphics over dubbed-down console versions
• A 30/60 fps toggle or graphical slider could be a compromise solution
• Modes is giving away a large amount of prizes, including an Oculus Rift and gaming equipment
• Modes is an IT staffing company that helps people find jobs and companies find employees
...
• Comparison of the original concept of touchpads vs. current prototypes
...
• Seagate buying Sand force from LSI for $450 million
...
• Discussion of Game Cube and its compatibility with Wii U
...
• Computer Maxwell releases
• Racer Blade 14 laptop release
