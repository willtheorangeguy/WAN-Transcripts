...
• Brand sponsorship opportunity for shaving one's beard
• Discussion of Mark Gatherer's (Rate Faber) criticism and surprise
...
• Attachment mechanism has no play, making it difficult to adjust for different hairstyles or preferences
...
• Joking conversation about the host dyeing his hair blonde and wearing a coloured polo shirt
...
• macOS frustrations, including limited screen real estate when not in full-screen mode
...
• The speaker recounts their experience with Final Fantasy Tactics, where they lost a character due to permanent.
...
• The importance of product colour options for consumers
• Apple's willingness to create products in other colours, but only under certain circumstances (e.g. red Macs)
...
• Hypocrisy and corporate defence strategies vs. taking responsibility for actions
...
• The narrator mentions that Apple Pay still exists despite rumours of it being discontinued
...
• The speaker shares a story about working at NCI and dealing with multiple bosses, leading to a conversation about why they hired a particular boss who made poor decisions.
...
• A hypothetical scenario where someone searches for a generic model (VGA GPU with lifetime warranty) and returns too many results
• Argument that no one would intentionally search for a partial UPC code
• Discussion about a experience where the speaker was sent to create a presentation on search engines and felt frustrated with the task
• The concept of leadership and empowerment, and how it can lead to problems when trying to explain things to others
• A story about a security vulnerability involving shared links in Teams, specifically the perpetual Sancho doc
...
• Mention of lock picking kits being legal and practically free
• Personal anecdotes about trying to learn lock picking and having practice locks
• Team-building exercise involving lock picking and other skills-based activities
...
• AG1 supplement promotes gut health, focus, energy, and immune defence
• Users can try AG1 with a free one-year supply of vitamin D3 plus K2 and five free AG1 travel packs
• PDF provides solutions to annoying PDF files
...
• Introduction and features of PDF as a simple AI solution for working with PDFs
• Comparison between PDF and other tools, including its ability to handle multiple devices and platforms
• Explanation of various tasks that can be performed with PDF, including text editing, image modification, and summarization
• Mention of a discount offer for PDF Pro and AI
...
• Comparison between Canadian and general politicians, labelling them as unqualified and unsupervised
• Discussion on the negative connotation of hacking and how it led to the ban of the Flipper Zero
• Banning of the Flipper Zero device due to its potential for hacking and cyberattacks
...
• Discussion of float plane exclusives and their quality
• Mention of extra content from Linus's Kids Build Luke a Computer, Media collab, and CEO interview with Taryn
...
• Mention of Gender in full plane chat and its comment on infrastructure issues
...
• Product review of a power supply (Sea sonic Focus GO 1000)
...
• Mention of audio quality issues and the potential for using a Tuber hosted format
• Discussing Numbering and virtual influencers
• Chilean collab plans
• Concerns about Chilean's backflips
• Setting up a Tuber studio with AAA motion capture hardware
• Discussing the current state of Numbering and its popularity
...
• Comparison to Float plane, a service that offers new content through subscriptions
...
• Proposal for a system where users can download entire back catalogues of content without limitations
...
• The user had their LDT backpack stolen while travelling in Europe
...
• They discuss travel plans, including a trip to Nuku Shiva for diving and a bucket list item to scuba dive in Australia.
...
• New mice being released, specifically the Super light 2, and high costs
...
• Discussion about optic ID, gaze tracking, and Power Play compatibility
...
• Ryan Trajan's method of holding a phone was discussed, specifically how he would pinch on an app to hold it in place while walking.
...
• The speaker shared their experience of reviewing multiple phones every month, which they found to be stressful and annoying.
...
• Float plane's analytics capabilities are compared to YouTube analytics, with the speaker stating that Float plane has little to no analytics features.
...
• Impact on troubleshooting and Los (Quality of Service) information
...
• Co-location and data centre selection for Flow plane is a separate task that AJ is handling
• OVH is a data centre platform used by the speaker
...
• The speaker believes OVH's uptime has been perfect overall
...
• Comparison of AG1's taste to pineapple/vanilla flavour
