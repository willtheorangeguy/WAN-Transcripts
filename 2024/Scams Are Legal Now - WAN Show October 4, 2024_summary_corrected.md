...
• Judge dismissing lawsuit due to corporate puffer defence
...
• Elon Musk is mentioned as an example of someone who has engaged in lying and misleading behaviour regarding his company's products
• The speaker argues that such behaviour is not something to be admired or respected, but rather criticized
• Puffer vs. false advertising is discussed, with the speaker suggesting a distinction between exaggerated praise (acceptable) and outright lies (not acceptable)
...
• Corporate puffer and its potential to be seen as either truthful marketing or misleading statements
...
• Examples of corporate puffer in statements made by the company about their team and products
• Discussion on whether certain phrases, such as "trust me, bro", constitute corporate puffer
• Discussion of whether statements about a product being "world-class" or having "full self-driving" capabilities are puffer
• Explanation that verbal irony is not the same as puffer, and requires an earnest statement to be considered puffer
• Examples given of statements that may be considered puffer, such as saying a show is great when it's actually not
• Acknowledgment that some statements can be seen as both puffer and humorously ironic at the same time
• Discussion about thumbnails and puffer
...
• Definition and examples of "puffer" (exaggerated or false praise)
• Debate on whether statements about product features and timelines can be considered puffer
...
• Discussion about marketing and promotional opportunities with Flow plane
• Discussion about a handheld device being referred to as "spy handed" or "two handed"
...
• Puffer mentioned in a conversation
...
• Discussion of speed limits in BC and driver behaviour
...
• fixity's partnership with a sponsor is being paused
• The reasons for the pause are unclear, but sound plausible and unrelated to the company
• fixity has no intention of forcing the partner to fulfill their contractual obligations
...
• Mention of employee models representing the brand and product
• Explanation of how employees are paid (hourly) but modelling is completely voluntary
...
• Compton certification controversy (Linus's A+ certification status)
...
• Sneezy business practices by Amazon
...
• Advertisement for Mans caped products and Squarespace website platform
...
• The topic shifts to high-end desktop (HEAT) chips, with one guest arguing that Intel and AMD waited too long to release them, allowing Apple's Mac Studio to dominate this space.
• Guests discuss how high-end consumer chips have taken over the role of Heats in providing powerful processing capabilities without breaking the bank.
• The conversation touches on ECC memory support for Ry zen 9000 processors and how it compares to previous generations.
• One guest argues that the only real reason to choose a true high-end desktop is for Mono memory bandwidth or PCIe expansion, which the Mac Studio can address.
...
• Companies may claim a product has a "lifetime" warranty but only honour it if you can prove a manufactured defect after years of use
• The term "lifetime" is often based on the manufacturer's definition, not the buyer's lifetime
• Some companies are more honest about their warranties and will honour them beyond what's reasonable or even after they've technically expired
...
• The trend of "ward robing", where people buy clothes to take Instagram photos and then return them
• Extended warranties and their predatory nature
• California's neural data protection law and its limitations
• Definition of neural data and concerns about physiological and behavioural data
...
• The conversation turns to the topic of land ownership, with the speaker owning multiple properties including a badminton centre
...
• Discussion about the state of a building, possibly referring to the Babbage Centre
...
• Suggestion of using AI tracking to monitor employee behaviour and productivity
...
• Nintendo shut down the Wii U shop last year and now is targeting emulators that allow dumping games to computers
• The Ruben X Nintendo Switch emulator has been wiped out after its lead developer was offered an agreement by Nintendo
• Discussion about using the Flutter framework for Float plane, but it's not being considered due to current development plans
...
• Discussion about not needing to spend real money on Star citizenships, but rather earning in-game currency
...
• Discussing the brand and product origins in Salome (Italy) and Solo Mid (small medieval village)
...
• Reference to a Latin phrase "Au Caesar, Au n'his" meaning either great success or nothing at all
...
• Discussion of what a Mc Mansion is and its definition
• Criticism of Mc Mansions for lacking architectural integrity and being tacky
...
• Reference to blogs that critique Mc Mansions
...
• Commentary on the humour in the situation
• Mention of a "Vox Media" thing, referring to big ships having round windows
...
• Discussion about the Mira effect, also referred to as moiré or screen door effect
