...
• Resolving a technical issue with the game's auto-rotation feature
• Identifying an Apple iOS limitation: lack of landscape lock on iPhones
• Explaining the "dip" maneuver for camera operators using iPhones as teleprompters
...
• They discuss the possibility of adding a settings shortcut to the control center, but ultimately decide against it.
• The conversation involves attempting to find the correct widget or feature to access settings.
• Discussion of settings menu in the control center on various platforms (Mac, Windows, Android)
• Whether settings is an app or a feature within another application
...
• Comparison between Apple and Android features, specifically Bluetooth settings and control center navigation
...
• Introduction of "juicefuls" (fruit gushers) snack controversy
• Discussion of video being taken down on YouTube/Floatplane
• Explanation of perceived permanence of videos online and risks of copyright overreach
• Examples of fair use defense in copyright law
...
• Ryugen X emulator was taken down after its owner was offered a bag of money to quietly delete the project.
...
• Importance of considering individual baggage and past experiences
...
• Rules for the challenge include guessing prices, having penalties for going over budget, and achieving best performance possible
...
• Discussion about a upcoming video that will shed light on something
...
• Discussion about a Floatplane exclusive shirt design with community input
• Reference to Linus and Luke reacting to a clip on WAN (Where Are the Nerds)
• Mention of early access to Floatplane content
• Technical issues with audio playback
• Plans for streaming on Floatplane, including a possible live stream
• Discussion of exclusive merch and its connection to Floatplane
• Clarification on who owns Linus Media Group Incorporated
• Mention of Starfield and eating habits
• Explanation of the integration between Floatplane and LTT store
• Discussion of a future feature that allows items purchased on one platform to be granted on the other platform
• Discussion of the profitability of Floatplane subs, specifically the OG subs
...
• Streaming is expensive compared to VOD
...
• Kik streaming platform removes Doherty's account and bans him for life due to reckless behavior
...
• Growing up with a generation that glorified reckless behavior (CKY, Jackass)
• Observations on the progression of "shock" humor
• Critique of the milk crate challenge and other inane stunts
• Discussion on why people continue to engage in reckless behavior despite potential consequences
...
• Difference between streaming and recording a VOD (Video On Demand)
• GameSense importance in streaming vs VOD
...
• Example of Samet successfully streaming while drifting without issue
...
• Drawing a line between acceptable and unacceptable behavior while streaming
...
• Definition of crossing the line in terms of streaming behaviors
• Comparison to committing crimes while streaming
• Dr. Disrespect streaming from a bathroom at TwitchCon
• Debate on whether this behavior is technically illegal
...
• YouTube policies on off-platform behavior
• The internet audience's tendency to reward or not penalize certain behaviors, even if they are wrong
...
• ADHD and neurodivergence are mentioned as potential traits exhibited by one of the speaker's children
...
• MSI MegCore LiquidEye 360 liquid cooler features and design
• Ridge wallet with RFID blocking, card capacity, and additional features
• Japanese cafe that employs paralyzed people to control robots using avatars
...
• Mullenweg allegedly threatened to take a "scorched-earth nuclear approach" unless WP Engine paid 8% of their revenue as a trademark fee or dedicated employee time to the project.
...
• 159 Automatic employees left the company due to disagreements with Mullenweg's leadership style.
...
• Fisker's bankruptcy proceedings highlight potential issues with cloud-based services in vehicles
• Cloud link transfer issue between Fisker and American Lease caused asset sale complications
...
• Discussion of car companies that have gone out of business, including Fisker and several brands from the 90s
...
• Discussion of Nintendo's new product, Alarmo, an alarm clock with motion detection features
...
• El Bardo comments on Nintendo's willingness to create unique products without following trends
...
• Explanation of the history behind NVIDIA and Apple's non-cooperation, citing "Bumpgate" as a reason for their split
...
• Conversation about an upcoming ISP or data center tour
