...
• Gray market products being sold in Canada as a result of unfavorable exchange rates and limited availability
• Personal experience with NCIX and managing Logitech products
...
• Mention of Dinga Bakaba's comments on avoiding obvious guidance as a choice that requires collaboration during development
...
• Discussion of a puzzle in Half-Life Alyx that was frustratingly unclear
...
• Color blindness issues in game design
...
• They express concerns about the potential for future technologies to blur the line between what's real and what's not, making it difficult to distinguish between reality and deepfaked content.
• The speaker discusses examples of deepfaking in the past, such as Will Smith's face being manipulated to eat spaghetti, and notes that these early attempts were often more challenging than current technology.
• They argue that the gap between current and past technology is smaller than people realize, and that future advancements will likely lead to increased demand for more sophisticated deepfaked content, including verification methods like webcam eating challenges.
• Discussion on AI-generated content and its potential for convincing deception
• Comparison of AI-generated content to deepfaking and its potential realism
• Example of a hypothetical cyberattack using deepfaked executives
...
• Luke asks about making pet-safe plushies, specifically a dog-friendly banana toy.
...
• Comparison of Grok to Furby and other interactive toys
...
• The conversation moves on to discussing sponsors for an event or podcast, and the speaker jokes that one of the sponsors is Backblaze because they "troll" him.
...
• Mention of Canadian rubles and confusion over prices
...
• Praise for Indian food as being affordable and flavorful
...
• A story is shared about going out for a expensive teppanyaki dinner and being surprised by the high price, leading to a discussion about food prices and affordability.
• The speaker discusses their experience with a restaurant chain called Ustad G and the high prices they pay
...
• The speaker recommends several restaurants, including Ustad G's Surrey Central location and Masala in Langley
...
• Backblaze cloud backup service offers unlimited storage and peace of mind for $9/month
...
• Backblaze has restored over 55 billion files and manages two exabytes of data
• Sponsor: Backblaze offers a free 15-day trial with no credit card required at backblaze.com
...
• Sponsor: Seasonic - reliable and quiet power supplies, including the TX-1000 model, which offers a 12-year warranty
• Seasonic power supplies have a transferable warranty of up to 12 years
• The warranty is applicable even if the original owner sells the product
• A new video on second-hand power supplies and Seasonic's warranty is being released soon
...
• Conversation about the obnoxious behavior of some users, particularly men, on the app
...
• IBM's data center capabilities, including up to eight nines of uptime, could be leveraged by companies
...
• Helldivers is mentioned as a co-op game and praised for its writing and voice acting.
• The speaker mentions having many games to play, including Divinity Original Sin 2 and Anno.
...
• Traveling with a rod (metal tool) without issues
...
• The person is reminiscing about a favorite food they had at one of the New York airports that has since closed.
• They mention having a reserve list of things to enjoy in case their favorites become unavailable.
...
• Extracting money from people through AI and gacha games
...
• Discussion about making Genshin content and keeping a job
• Mention of spending money at LTT store as a condition
• Reference to Luke working on Genshin and not coordinating a related topic
• Discussion about playing The Legend of Zelda: Breath of the Wild, including unfinished business with Korok nuts and Ganondorf
...
• The speaker who watched part of the review comments on its length and compares it unfavorably to Mark Zuckerberg's own content
...
• Discussion on how the headset is not suitable for certain tasks, such as playing games like Beat Saber or Fruit Ninja
...
• Canadian airline Air Canada forced to honor chatbot claims after customer was denied bereavement discount
...
• The conversation shifts to football, where they recall blocking a kick as a defensive end and another time when themselves and a teammate broke through the quarterback's defense but failed to recover the ball
...
• News about an emulator for CUDA, Zaluda, and its funding from AMD and Intel
...
• Modern GPUs prioritize other means of achieving high speeds, such as HBM or moving memory closer to the compute
...
• Nvidia's next flagship GPU rumored to have a 512 bit bus
...
• The tension between using derogatory terms to criticize someone's behavior versus labeling them with a specific type or label (e.g. racist, sexist)
...
• Early days of OLEDs and a past experience with sponsored videos
• Discussion about buying vs recommending products, specifically OLEDs
...
• Went down a "rabbit hole" researching Chiro, finding that they appear to have done nothing in 9 years
...
• Mention of Chiro as a sponsor and a previously liked product line
• Explanation of dual-layer LCD technology and its display capabilities
• Commentary on companies changing branding and names (Hisense/ULED)
• Personal anecdote about scuba certification and favorite dive spots
...
• The speaker mentions the "n***ification" of retail and the idea of creating a trusted store like Costco where products are verified and guaranteed to be good.
...
• Origins of the Browns' color, brown, and its irony as a choice for a sports team
...
• Combining technology and theater productions
...
• Personal anecdote about EVGA GPU purchase
• Question about favorite retro games
