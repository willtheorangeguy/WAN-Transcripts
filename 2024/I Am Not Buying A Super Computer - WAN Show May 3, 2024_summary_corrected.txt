...
• Markov update and community reaction
• Battle state Games' handling of controversy
...
• They mention that a game called Escape from Markov is a more realistic and challenging experience compared to Call of Duty.
• In Escape from Markov, players must reload magazines individually and cannot teleport ammo between mags.
• The Unheard Edition of Escape from Markov includes the ability to call in teammate reinforcements, which is seen as problematic due to the potential for cheating and exploitation.
...
• The caller criticizes the introduction of the Edge of Darkness copy of Escape from Markov, which offers future DLC for free but is seen as overpriced.
• New version of the game released with limitations
• Co-op EVE mode and other features promised for Edge of Darkness players
• Complaints about pay-to-win mechanics, including a "legacy device" that summons an armoured vehicle
...
• Interview discussion about Escape from Markov
...
• Modding of single-player Markov to improve gameplay experience
• Multiplayer mod FIFA and its smooth performance
• Comparison with live gameplay experience
• Hell divers update requiring a PlayStation Network account for PC players
...
• Mat Pat's retirement from Game Theorist and meeting him at his party
• Collaborative video shoot with HP Enterprise and Kiowa on the Spaceborne 2 computer
...
• Advantage games brought by each competitor (Ludwig's: Biro Cart, GeoGuessr, Taken 8; Linus': Tower fall, Beat Safer, Drunken Fight Simulator)
...
• The speaker's recent game of rock-paper-scissors was unusual due to its swing nature and the number of games required to determine a winner (12-13 rounds).
...
• The conversation also touches on other videos, including Luke's chicken recipe and his video showcasing his neighbourhood
• Discussion of eating animals in front of birds and whether it would affect their behaviour
...
• Proposals include making life-size alpaca plush toys and filling whale plushes with alpaca wool
...
• Discussion of joining the military or government for cybersecurity work
• Career path and job at NCI
...
• Concerns about power dynamics and potential pressure on employees to engage in such behaviour
...
• Messi sponsorship and advertising of their waterproof shoes
• Description of Messi's technology and product features
• Promotion code for Messi products (15% off first purchase)
...
• Promotion for WAN show with a discount code
• Mans caped grooming products, including the Lawnmower 5.0 Ultra and various tools and formulations
...
• Colour tests for various coat options planned for the weekend
• Acquiring speed shapes from AliExpress for painting and testing
• Considering settling on a colour choice despite not meeting ideal standards
...
• Chinese knock off companies likely to cut corners on materials
...
• Commenter Goalkeeper's statement about people watching F1 only when things go wrong
...
• Discussion about a dash cam video showing a car performing an extreme manoeuvre, with one person expressing concern for safety and another person reacting in amusement.
...
• A technical user expresses frustration at this change, preferring the convenience of easy-to-remember default passwords, but acknowledges its necessary for security reasons.
...
• Marketing strategies and controlling consumer behaviour
...
• The difficulty in addressing why people insist on ignoring Apple's actions despite clear evidence of their behaviour
• Reading habits and speed
• Website communities and reader saltiness (Ars Technica vs. The Verge)
• Anti-competitive behaviour in business
...
• Discussion of companies or brands that may be avoided due to experiences or controversies
...
• Certain companies have a history of unethical behaviour that may justify avoiding their products
...
• Mention of Hanson's Razor and its application to the situation
...
• Personal anecdote about learning from experiences of being too trusting
...
• Mention of pause ads on smart TVs and ROK
...
• Questions about LTT store merchandise (wind breaker pockets)
...
• TSP (Tribolium Phosphate) for wall prep and cleaning
...
• Additives in paint, including colouring pigments and blocking pigments
...
• Mention of attending Open Sauce and discussing FFmpeg and its importance
...
• Comparison of Float plane to companies that crunch to meet deadlines
...
• Celebrity encounter with Multiplier
• Meeting a celebrity (Ego raptor/Star bomb) at Starbucks and the person's lack of recognition
• The person's encounter with Ego raptor at an event where they didn't realize who he was until later
...
• A listener asking about Luke's approach to building Flow plane, specifically how he decided what technology to use
...
• Decision-making process at Float plane (involving AJ, Jake, and the team)
...
• Favourite gear is functional rather than aesthetically pleasing
...
• Discussion of a new device with a giant touchscreen and its uninterruptible nature
