...
• Comparison between this incident and past examples where companies have used jurisdiction as a defense
...
• Disney is losing viewership to YouTube, particularly with content from creators like "Miss Rachel" and Cocomelon
...
• Mention of Blippi and its $3 billion acquisition by Disney
...
• The bag's construction, including YKK zippers, is highlighted as contributing to its cost
...
• The hosts discuss a large number of pens being ordered through merch messages.
...
• RealPage's AI revenue management algorithm and alleged antitrust violations
...
• Reference to a lawsuit by RealPage against the company, with allegations of collusion and price fixing
• Comparison between AI systems and human behavior
...
• Misinformation about the rotisserie chicken being a loss leader, corrected by CFO Richard Galanti
...
• Comparison of infrastructure departments being referred to as "cost centers" or "burden department"
...
• Mention of a badminton center being considered a cost center, not a loss leader
• The speaker had a meeting with the general manager of the city of Surrey
• Cities have a general manager, not just a mayor
• The meeting was over two hours long and included site visits to Smash Champs (Whale Lands badminton center)
...
• Mention of "improv rules" and working together without saying no
...
• Parking as a major issue in industrial parks and potential solutions involving neighbors or shuttle services
...
• The group met up with Thor, pirate software, and Primogen, among other individuals who prefer not to be named or photographed.
...
• The speakers brought old, non-updated phones to the event as a test of wifi security
• They attempted to connect their devices to open wifi networks on the show floor
• The convention had a "wall of sheep" where attendees who got "owned" at the event were listed
• The speakers discussed how no one would use zero-day exploits or sophisticated attacks at DEF CON, making it a relatively safe environment for testing wifi security
• DEF CON experience
...
• SteamOS updates including support for extra ROG ally keys and Windows support on the Steam Deck OLED
...
• Mention of ISPs' clauses against sharing internet with neighbors
...
• Criticism of the security practices of companies, particularly in regards to two-factor authentication
• Difficulty changing personal identification numbers (PINS) and social insurance numbers
• Discussion of JEDEC and its impact on laptop design
• Upgradable memory in GPUs and the reasons it is no longer practical
• CAM 2 technology limitations in laptops
• Signaling and transfer rates in memory modules
• Comparison of soldered vs non-soldered memory (SODIM) in laptop design
• AMD's support for non-soldered memory
• Linus Tech Tips show discussion about drywalling and construction projects
...
• Taron's role in facilitating connections and support network
