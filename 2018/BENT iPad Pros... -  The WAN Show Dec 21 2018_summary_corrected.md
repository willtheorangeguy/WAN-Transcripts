...
• WAN Showtime is discussing various topics, including Flow plane updates, Linus Tech Tips updates, and new merchandise
• Rumours are circulating that Nvidia will be launching the GTX 11 series
...
• Flow plane has enabled load balancing for live streams and edge servers to improve video delivery
• Float plane through forum will be going away in 10 days due to accounting reasons
• Fiscal year-end for Linus Media Group and Float plane Media is December 31st
...
• Request for tutorials on switching from a monthly to yearly subscription to float plane
• Cost of Linus Tech Tips subscriptions
• G Suite and individual accounts for members
• Two-factor authentication (2FA) addition on Float plane
• Support page creation for member inquiries
• Pricing structure inconsistencies between YouTube and Float plane memberships
• Features unavailable on Float plane due to technical limitations
...
• Questioning the line between protecting likenesses and using cartoon game characters
...
• Example of Samuel L. Jackson's iconic villain in Kinsman and potential implications for Fortnite emotes
...
• Comment on a YouTube video or stream (Float plane)
...
• Discussion of Float plane Chat and its importance
...
• MADE is coming to the show and is excited
• Request for Saigon of Akkad to join float plane as a host
...
• Trademark disputes, including Disney's trademark of "Kakuna Mata ta"
...
• The shirt features a subtle design with constellations and an LTT logo in the centre
...
• The team created an 8K Blog, but its status as the world's first is unknown
...
• Easter eggs are hidden in the Blog video