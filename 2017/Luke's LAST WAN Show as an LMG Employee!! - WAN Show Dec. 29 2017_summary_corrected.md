...
• Apple responds to the iPhone slowdown controversy, and fixity drops their iPhone battery replacement price
...
• Discussion about the relative lack of security for celebrities outside their work due to their lesser financial means
...
• Clarification of job titles and roles within Float plane Media, including the meaning of COO and CEO
• Future plans for Float plane's growth and possible expansion to a new building
• The float plane is not failing, but rather a test that has already been completed
...
• Transparency about customer data storage and handling by Float plane (a company mentioned in the conversation)
...
• fixity's iPhone battery replacement kit and its cost-effectiveness compared to Apple's Genius Bar service
• The convenience of DIY battery replacements using the fixity kit, including having access to tools and spare batteries
• Variations in products
• Nice stuff included with purchases (e.g. screwdriver, tweezers, suction cups)
• Sponsorship by Marina's Coffee
• Description of Marina's Coffee products and promotion (60% off code LINUS for first 100 customers)
...
• The host tries various flavours of jerky from Savage Jerky Co.
...
• The behaviour pattern must be severe enough to cause significant impairment in various areas of life
• Recurrence of the behaviour is sufficient for a diagnosis, but symptoms should persist for at least 12 months
...
• Upcoming charity stream and support quest issues on Float plane
...
• Mention of a USB-C video by Kyle for Nitwit subscribers
