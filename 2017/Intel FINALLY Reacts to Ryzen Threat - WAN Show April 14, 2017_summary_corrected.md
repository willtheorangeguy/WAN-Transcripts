...
• Rumoured release date: April 18th
...
• Intel Skylike X and Kaby Lake X processors rumoured to arrive early
...
• Mention of Intel's response to Ry zen 7 and their accelerated release schedule for Skylike X and Kaby Lake X
• Skylike X moving up from Q3 to June
• Kaby Lake X will be released on 2066 sockets with reduced features (4 cores, dual channel memory, fewer PCI-E lanes)
• Discussion of the benefits and drawbacks of higher-end platforms vs lower-end ones
• The speaker is discussing a rumour about Intel's Kaby Lake G series
...
• Unpaid as a solution for running both SLI and Crossfire on the same box
• Virtualization limitations with current setup
• Alternative plans using Unpaid to achieve optimal gaming performance
...
• Degradability of machines with separate monitor, keyboard, and mouse setup
• Hackintosh and Windows PC in one build
• Difficulty of working with Unpaid around Hackintosh systems
...
• Description of the knife looking like a small, weenie knife
...
• fixity repair kits can be purchased and used at home
...
• Thermal constraints are a major issue, with newer GPUs being more efficient and CPUs still holding similar class Leon standards
...
• Debate about Burke's skills with go karts vs Dennis
• Unboxing of a device generates many replies
• Float plane game is like actually playing on a float plane
...
• Embargo on Ry zen 5 and its impact
...
• The speaker compares the situation to Nintendo discontinuing the NEW Classic, citing ridiculous profits
• Discussion of Wii U sales
• NEW Classic discontinuation and high demand
• Potential for additional shipments of NEW Classic
• Criticism of Nintendo's decision to discontinue the NEW Classic controller
...
• Comparison of experiences with current situation
