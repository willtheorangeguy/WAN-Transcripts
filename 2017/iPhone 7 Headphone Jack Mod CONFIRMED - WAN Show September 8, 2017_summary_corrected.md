...
• Linus claims he will be travelling to Sweden for work, but there are concerns that something else may be going on
• Plans to visit a friend and work on float plane projects
• Reminder about telling mother before leaving the country
• Discussion about travelling without a place to stay
...
• Introduction of Der Bauer, a famous overclocked
...
• Upcoming video on de-linking Intel processors
• Mainstream vs high-end CPU discussion
• Strip-down of a 7900X processor
• Comparison with AMD Ryzen and Thread ripper chips
• Using a powerful cooler on the 7900X to manage heat
• Intel's use of thermal interface material instead of soldering
• The author's intention to attempt to deal with a Thread ripper chip
• A vanity Thread ripper chip provided to YouTubers
...
• Samsung's UI and Touch ID features
...
• There is a rumour about AMD Vega 11 GPUs entering production with Vega 20 on 7 nanometers and replacing Polaris 10/20 in RX 580/570 graphics cards
...
• AMD's next generation high-end graphics chips (Vega 20) will be made at TSMC using their 7 nanometre process technology
...
• Links to purchase the headset through Amazon or New egg via Twitch chat
...
• Cancelling microbial growth and smell in clothing
• Mack Weldon's return policy and promo code TECHNICS for 20% off at MackWeldon.com
• Intel discontinuing the Core i7 6700K and 6600K CPUs
• Rumours of Coffee Lake coming soon, likely replacing current products
...
• Five (HTC's VR division) has been doing slightly better in recent times due to discounts and upcoming games
...
• Cyberattack on Equifax affecting 143 million US consumers
• Importance of doing one's own research to check if affected by cyberattack
...
• A Core i7-8700K and 8700 processors are being released with six cores and 12 threads
• The processors have high single core and multicore boost speeds
• Discussion of the X299 and X399 platforms being unnecessarily expensive for most people
• Mention of an Organization vlog 3 trailers on Facebook
...
• Chat link discussion with Float plane
• Introduction of various game activities and events on Float plane, including an archive of daily live streams
...
• Criticism of impracticality of Hyperloop as transportation systems
...
• Announcement of upcoming motherboard reviews, including one for As rock's X299 Mini IT board
...
• Encounter with an Unpaid build at PAX BYOC that had two setups in one tower
• Plans for upcoming Intel higher core count, high-end desktop parts and its application in future projects
• Mention of a possible "Fire engine" build featuring two discrete function machines in a single tower