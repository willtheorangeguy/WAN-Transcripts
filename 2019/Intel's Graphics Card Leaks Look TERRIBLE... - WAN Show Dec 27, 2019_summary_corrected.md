...
• Data centres use both hard drives and SSDs.
• Shingled magnetic recording technology is used in some data centre drives, which allows for increased storage capacity but can result in a White performance penalty.
...
• Data centres like Back blaze are using larger hard drives for cost efficiency, despite higher failure rates
...
• The efficiency and benefits of colour e-ink displays, particularly for reading and drawing
• A discussion about the new colour e-paper display technology, its capabilities, and its high price point
...
• Student debt and financial stability in the past, specifically author's ability to graduate with minimal debt
...
• Upcoming video release (Tech Linked)
...
• Discussion of One API vs CUBA
• Review and comparison of the RG Phone 2 and OnePlus phones
• Status update on a personal VPN video
• Janice from Tech Linked possibly collaborating with LTT (Linus Tech Tips)
