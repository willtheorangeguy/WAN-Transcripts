...
• Willingness to give up right to sell games in favour of digital distribution
...
• Author's frustration with this practice at NCI
...
• Sonic power supplies and their features
• YouTube's verification badge policy changes
• Float plane updates: yearly payments, comment moderation, 4K video support
...
• The speaker argues that verification is more than just a badge of honour, but also serves a practical purpose, such as preventing impersonation and spam accounts.
• Taken van Helmet, another YouTuber, had his identity confused with an unrelated person due to similar names, highlighting the issue with Twitter's verification system.
...
• Hillbilly humour content contest announcement
• Reselling Red Hat licenses with new challenges
• Visit to Anna game developer in Germany
...
• Discussion of RAID parody checks in the Unpaid system
...
• Discussion of a surround sound speaker setup and multichannel audio
• Use of a specific app to lock the mouse to the primary display for a phantom cloned display
• Possible use of an additional cable for multichannel audio
• Float plane discussion: grandfathered users, yearly subscription option, and potential changes
• Shirts and merchandise: OnePlus TV review, possible float plane shirt, and LTT store issues
