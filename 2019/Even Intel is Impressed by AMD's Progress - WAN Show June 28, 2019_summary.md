...
• Experiences with a home theater PC system and the challenges of universal remote control
...
• Upcoming editing showdown competition between Taron van Hemert and Jonathan Morrison from The Logitech Diaries
• Discussion of wanting to have celebrity judges for a project, but struggling with scheduling due to their busy schedules
• Criticism of Apple's calendar app as being worthless and comparing it unfavorably to Google Calendar or the third-party Business Calendar app on Android
...
• AMD has experienced 2 years of over 20% annual revenue growth, attributed to Ryzen and EPYC
• AMD is a formidable competitor across the entire product stack, from low-end CPUs to high-end data center products
...
• The shift in consumer sentiment from favoring Intel to embracing AMD
...
• Recalls buying cheap Anion memory (1GB for $10, 2GB for $20) during the Kimonda liquidation sale
...
• Prizing and sponsorships for the event, including a large shipment of graphics cards from Nvidia and Zotac
...
• Exhibitors, including Razor, Memex, MSI, and BS Mods
• Featured hardware brands and products, such as CPU delidding tools
...
• Thunderbolt 3 is mentioned, with its bi-directional full duplex link and allocation of two lanes for each direction, which is different from displayport's focus on sending large volumes of data in one direction
